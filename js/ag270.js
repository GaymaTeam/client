...
}, window.localStorage.settings ? JSON.parse(window.localStorage.settings) : {});
...
const youtubeChannels = [
    ...
    { skinId: 1657, id: 'UCneU-0NP-BUHGoahZ8xsiTg', verified: true },
    { skinId: 2281, id: 'UC9v2PgTIQ24XaW7hhzfZAkQ', verified: false },
    { skinId: 2282, id: 'UCDlg1maSU9SLQyD2o5zg-LQ', verified: true },
    { skinId: 2297, id: 'UCnZf3yC2jRNoRYV_Z7A7VJg', verified: true },
    { skinId: 2331, id: 'UCiQ9ppFo-X24RrF-h9Grbgw', verified: false },
    { skinId: 2529, id: 'UCmnPF8dH7sJN8qvxhXg7eSA', verified: true },
    { skinId: 2626, id: 'UCGvx6BbsFg1IB1nJTRvm1DQ', verified: false },
    { skinId: 2683, id: 'UCWSKctuGO6dOPp-9FRUpGUA', verified: false },
    { skinId: 2816, id: 'UCYIzeLC1Jp7y1klvoPEW1sA', verified: false },
    { skinId: 2832, id: 'UCNaj0L-_RJziNMZTzJghiuw', verified: false }
];
const supportFileDragAndDrop = "ondrop" in document.createElement("div") && "FormData" in window && "FileReader" in window;
const isFirefox = /firefox/i.test(navigator.userAgent);
const gameServerModes = {
    0: "Free For All",
    1: "Teams",
    2: "Experimental",
    6: "Selffeed",
    ...
    17: "Infection",
    18: "Domination"
    // 22: "Domination DodgeBall" ?
};
const defaultGameservers = [
    { id: 9,  name: 'Crazy EU',          description: '', address: 's9.agma.io:2087',  location: 0, gamemode: getModeFromId(0),  players: 0, maxPlayers: 150, isCurrent: false },
    { id: 11, name: 'Gigantic',          description: '', address: 's11.agma.io:2053', location: 0, gamemode: getModeFromId(2),  players: 0, maxPlayers: 150, isCurrent: false },
    { id: 19, name: 'Gigantic 2',        description: '', address: 's19.agma.io:451',  location: 0, gamemode: getModeFromId(2),  players: 0, maxPlayers: 150, isCurrent: false },
    { id: 37, name: 'MegaSplit EU',      description: '', address: 's37.agma.io:452',  location: 0, gamemode: getModeFromId(2),  players: 0, maxPlayers: 150, isCurrent: false },
    { id: 38, name: 'SOLO Agf.io',       description: '', address: 's38.agma.io:452',  location: 1, gamemode: getModeFromId(0),  players: 0, maxPlayers: 150, isCurrent: false },
    { id: 20, name: 'Crazy NA',          description: '', address: 's20.agma.io:2087', location: 1, gamemode: getModeFromId(0),  players: 0, maxPlayers: 150, isCurrent: false },
    { id: 5,  name: 'Splitrun Paradise', description: '', address: 's5.agma.io:456',   location: 1, gamemode: getModeFromId(0),  players: 0, maxPlayers: 150, isCurrent: false },
    { id: 12, name: 'Giant',             description: '', address: 's12.agma.io:2087', location: 1, gamemode: getModeFromId(2),  players: 0, maxPlayers: 150, isCurrent: false },
    { id: 17, name: 'Crazy Asia',        description: '', address: 's17.agma.io:452',  location: 2, gamemode: getModeFromId(0),  players: 0, maxPlayers: 150, isCurrent: false },
    { id: 18, name: 'Giga',              description: '', address: 's18.agma.io:452',  location: 2, gamemode: getModeFromId(2),  players: 0, maxPlayers: 150, isCurrent: false },
    { id: 26, name: 'Giga 2',            description: '', address: 's26.agma.io:451',  location: 2, gamemode: getModeFromId(2),  players: 0, maxPlayers: 150, isCurrent: false },
...
const hitAnimations = newImage("img/animations/hit.png");
const speedlinesAnimations = newImage("img/animations/speedlines.png");
const speedcirclesAnimations = newImage("img/animations/speedcircles.png");
const chaticonsImage = newImage("img/chaticons14.png?v=6");
const emojisheetEmotes = newImage("emotes/emojisheet.png");
const fixedMouseImage = newImage("img/mousecursor.png");
const animationTimeFunctionA = dt => framesCounter + ~~(60 * (dt || 0) / 1000);
const animationTimeFunctionB = dt => currentFrameTime + (dt || 0);
const playerEmotes = {
    ...
    92: { time: animationTimeFunctionB, duration: 2400 },
    93: { time: animationTimeFunctionB, duration: 2800 },
    94: { time: animationTimeFunctionB, duration: 1900 },
    95: { time: animationTimeFunctionB, duration: 2400 },
    96: { time: animationTimeFunctionB, duration: 2500 },
    97: { time: animationTimeFunctionB, duration: 2600 },
    98: { time: animationTimeFunctionB, duration: 2600 },
    99: { time: animationTimeFunctionB, duration: 1800 },
    102: { time: animationTimeFunctionB, duration: 2400 },
    103: { time: animationTimeFunctionB, duration: 2600 },
    104: { time: animationTimeFunctionB, duration: 1800 }
};
...
window.onload = function() {
    ...
    _0x492d1e.ondragenter = _0x492d1e.ondragover = function(_0x3ee492) {
        ...
        if (supportFileDragAndDrop && _0x3ee492.dataTransfer) {
    ...
    document.getElementById("chtTabs").onclick = function(event) {
        updateTab(event.target);
    ...
    _0x4110a1.onmouseover = _0x4110a1.onmousemove = function(_0x528b00) {
        ...
        _0xe31aef = currentFrameTime + 200;
    };
    ...
    _0x4eac2b.onmousedown = function(_0x34757a) {
        if (0 == _0x34757a.button) {
            if (1 == _0x47ccce) {
                ...
                if (!_0x3e08c0 && !_0x181957 && 0 < mainPlayerCellsIds.length) {
                    var _0x5deb31 = null;
                    var _0x5ec5a8 = (_0x2f8185.pageX - clientWidth / 2) / _0x3e50d9 + viewX;
                    var _0x12065b = (_0x2f8185.pageY - clientHeight / 2) / _0x3e50d9 + viewY;
                    for (var i = allNonFoodCells.length - 1; 0 <= i; i--) {
                        var cell = allNonFoodCells[i];
                        if (0 == cell.type) {
                            var ox = cell.x - _0x5ec5a8;
                            var oy = cell.y - _0x12065b;
                            if (ox * ox + oy * oy < cell.size * cell.size) {
                                _0x5deb31 = cell;
                                break;
                            }
                        }
                    ...
                    if (_0x5deb31) {
                        _0x2f8185 = mainPlayerCellsIds.indexOf(_0x5deb31.id);
                        new PacketWriter(6).setUint8(162).setUint8(_0x2f8185).setUint32(_0x5deb31.pid).send();
                    }
                }
            }
            _0xed8399(_0x34757a);
    ...
    window.onkeydown = function(_0x244728) {
        ...
        switch (_0x244728.keyCode) {
            case 27:
                ...
                if (0 == _0x4f6092.length) {
                    if (_0xbbfdd2 || _0x2bc2d5 || _0x29894d || contextMenuVisible || _0x181957 || _0x4a595d || _0x34cf3b) {
                        _0x472070.blur();
                        _0x1e0756.blur();
                        _0x6da0af();
                        _0x492dec();
            ...
            case 37:
                ...
                break;
            case 39:
                if (contextMenuVisible && (_0x4f6092 = $("#contextMenu").find("li.context-has-submenu.hover")) && _0x4f6092.length && _0x4f6092[0] !== _0xab54f2 && (_0x2b63fd(), _0x460313(), _0x218784)) {
...
window.connectserver = window.setserver = function(_0x4537b3, _0x148016) {
    if (0 == _0x2b8278) {
        ...
        _0x38891d = _0x148016 || '';
        wsConnect();
        if (_0x148016 = getServerFromAddress(_0x4537b3)) {
            _0x40eece(_0x148016.gamemode);
        }
        currentServerId = _0x148016 ? _0x148016.id : 0;
    }
};
...
function _0x491923(_0x4c7278) {
    var _0x203d30;
    if (!_0x3e08c0 && (_0x203d30 = selectedMessage, selectedMessage = _0x191230(_0x4c7278.clientX, _0x4c7278.clientY), _0x203d30 || selectedMessage)) {
        _0x4cb089 = !(_0x10e53d = null);
    }
}
...
function _0xed8399(_0x4c53ad) {
    if (!(_0x3e08c0 || _0x181957 || !isSpectating || 0 != mainPlayerCellsIds.length)) {
        hideContextMenu();
        _0x3169a6(_0x4c53ad);
        $("#contextMenu").find("li.hover").removeClass("hover");
...
function _0x3169a6(_0x4dc13e) {
    if (!_0x3e08c0 && (_0x4dc13e.preventDefault(), !_0x181957)) {
        ...
        var _0x5c09e8 = null;
        if (!selectedMessage) {
            var _0x3e0f5a = (_0x4dc13e.pageX - clientWidth / 2) / _0x3e50d9 + viewX;
            var _0x56bce2 = (_0x4dc13e.pageY - clientHeight / 2) / _0x3e50d9 + viewY;
            for (var n = allNonFoodCells.length - 1; 0 <= n; n--) {
                var cell = allNonFoodCells[n];
                if (0 == cell.type) {
                    var ox = cell.x - _0x3e0f5a;
                    var oy = cell.y - _0x56bce2;
                    if (ox * ox + oy * oy < cell.size * cell.size) {
                        _0x5c09e8 = cell;
                        break;
                    }
        ...
        if (selectedMessage || _0x5c09e8) {
            if (selectedMessage) {
                if (isReady() && selectedMessage.sid == currentServerId && 0 != selectedMessage.pid) {
                    new PacketWriter(6).setUint8(60).setUint8(0).setUint32(selectedMessage.pid).send();
                }
                $("#contextPlayerSkin").css({
                    "background-image": '',
                    "background-color": selectedMessage.color
                });
                $(".context-player-wear").css("background-image", '').hide();
                $("#contextPlayerName").text(selectedMessage.name).css("color", '').removeClass("gold black");
                if (selectedMessage.goldMember) {
                    $("#contextPlayerName").addClass("gold");
                }
                if (selectedMessage.sid == currentServerId && 0 != selectedMessage.pid) {
                    ...
                    if (isSpectating && 0 == mainPlayerCellsIds.length) {
                ...
                $("#contextPlayerName").text(_0x5c09e8.name || "Agma.io Player").css("color", _0x5c09e8.name && 1 < _0x5c09e8.colorIndexName ? nicknameColors[_0x5c09e8.colorIndexName] : '').removeClass("gold black");
                if (_0x5c09e8.name) {
                    if (1 == _0x5c09e8.colorIndexName) {
                        $("#contextPlayerName").addClass("gold");
                    } else if (6 == _0x5c09e8.colorIndexName) {
        ...
        var _0x327cd3 = Math.max(clientHeight < _0x327cd3 + _0x24ed85 && 0 <= _0x327cd3 - _0x24ed85 + 1 ? _0x327cd3 - _0x24ed85 + 1 : Math.min(_0x327cd3, clientHeight - _0x24ed85), 0);
        var _0x4dc13e = Math.clamp(_0x4dc13e, 0, clientWidth - _0x12641b);
        var _0x46542c = {
            top: _0x327cd3,
            left: _0x4dc13e
        };
...
function _0x337253(_0x1c5f0b) {
    ...
    var _0x5a7084 = Math.max(clientHeight < _0x563d51 - 4 + _0x299143 && 0 <= _0x563d51 + 4 + _0x5a7084 - _0x299143 ? _0x563d51 + 4 + _0x5a7084 - _0x299143 : Math.min(_0x563d51 - 4, clientHeight - _0x299143), 0);
    var _0x563d51 = Math.max(clientWidth < _0x9a3a28 - 4 + _0x21a675 + _0x5b5cdd ? 0 <= _0x9a3a28 + 4 - _0x5b5cdd ? _0x9a3a28 + 4 - _0x5b5cdd : _0x9a3a28 <= clientWidth - _0x9a3a28 - _0x21a675 ? clientWidth - _0x5b5cdd : 0 : Math.min(_0x9a3a28 - 4 + _0x21a675, clientWidth - _0x5b5cdd), 0);
    var _0x50776 = {
        top: _0x5a7084,
        left: _0x563d51
    };
...
function hideContextMenu() {
    if (contextMenuVisible) {
        ...
        if (selectedMessage) {
            _0x4cb089 = !(selectedMessage = null);
        }
...
function _0x548e1b() {
    ...
    var _0x551cbe = 1200 - (_0x3e8e1d - _0x51e494.lastThievingTime.minions);
    if (_0x4c32dc < 0) _0x4c32dc = 0;
    if (_0x39dfe9 < 0) _0x39dfe9 = 0;
    if (_0x507d30 < 0) _0x507d30 = 0;
    if (_0x373787 < 0) _0x373787 = 0;
    ...
    return {
        ...
        "powerups": 0 < _0x373787 ? " (" + _0x56b8c5 + "m " + _0x197f26 + "s left)" : '',
        "minions": 0 < _0x551cbe ? " (" + minutesLeftMinions + "m " + secondsLeftMinions + "s left)" : ''
    };
}
...
function _0x46c13b(_0x15d440) {
    ...
    if (_0x15d440 && (_0x15d440.currentTarget && (_0x1901e4 = (_0x38ea75 = $(_0x15d440.currentTarget)).outerHeight(), clientHeight < _0x1901e4) && (_0x15d440.pageY > clientHeight - 10 && _0x15d440.pageY < clientHeight ? _0x38ea75.is(":animated") || _0x38ea75.animate({
            "top": clientHeight - _0x1901e4
...
function _0x194510(_0x141d9a) {
    ...
    if (_0x141d9a && (_0x538e54 = (_0x4ed63b = $(_0x218784 ? "#contextSubMenu" : "#contextMenu")).find("li.enabled")) && _0x538e54.length && (_0x318516 = (_0x318516 = ((_0x318516 = _0x538e54.filter(".hover")) && _0x318516.length ? _0x538e54.index(_0x318516[0]) : -1) + parseInt(_0x141d9a)) < 0 ? _0x538e54.length - 1 : _0x318516 >= _0x538e54.length ? 0 : _0x318516, _0x4ed63b.find("li.hover").removeClass("hover"), (_0x141d9a = _0x538e54.eq(_0x318516)).addClass("hover"), 0 < _0x141d9a.length)) {
        ...
        if (clientHeight - 2 < _0x538e54 + _0x318516) {
            _0x4ed63b.stop(true, false).css({
                "top": "-=" + (_0x538e54 + _0x318516 - clientHeight + 2)
            });
        } else if (_0x538e54 < 2) {
            _0x4ed63b.stop(true, false).css({
                "top": "-=" + (_0x538e54 - 2)
    ...
    if (_0x5871e0 && _0x5871e0.length) {
        ...
        switch (_0x1f7dac.id) {
            ...
            case "contextFriendAdd":
                if (selectedMessage && 2 == selectedMessage.category) {
                    sendString(81, selectedMessage.name);
                } else {
                    sendSignal(84);
                }
                hideContextMenu();
            ...
            case "contextPrivateMessage":
                if (selectedMessage && 2 == selectedMessage.category) {
                    insertPMText(selectedMessage.name);
                } else {
                    sendSignal(45);
                }
                hideContextMenu();
            ...
            switch (_0xab54f2.id) {
                case "contextUnmute":
                    ...
                    if (_0x53dbfd) {
                        ...
                        if (_0x2f707e[_0x53dbfd.uid] && (_0x2f707e[_0x53dbfd.uid]--, _0x2f707e[_0x53dbfd.uid] <= 0)) {
                            delete _0x2f707e[_0x53dbfd.uid];
                        }
                        if (_0x538120[_0x53dbfd.iid] && (_0x538120[_0x53dbfd.iid]--, _0x538120[_0x53dbfd.iid] <= 0)) {
                            delete _0x538120[_0x53dbfd.iid];
                        }
                        curserMessage("Unmuted " + _0x53dbfd.name, false, false, 1, 10);
                    } else {
                        _0x5e5c13 = [];
                        curserMessage("Unmuted all players", !(_0x538120 = {}), !(_0x2f707e = {}), 1, 10);
                    }
                    _0x4cb089 = true;
                    hideContextMenu();
                    break;
...
function curserMessage(message, isHtml, isBold, color, fadeAfter) {
    ...
    if (isHtml) {
        _0x4b1b06.html(message);
    } else {
        _0x4b1b06.text(message);
    }
    _0x4b1b06.css({
        "fontSize": isBold ? "24px" : "18px",
        "color": 2 == color ? "#999999" : 1 == color ? "#00C000" : "#FF0000"
    });
    if (!_0x4243db) {
...
function _0x23a624(_0x5c9470) {
    ...
    if (_0x5c9470) {
        ...
        if (!(_0xde408[_0x4a7f30] || _0x4a7f30 == _0xea465f.toLowerCase())) {
            ...
            _0x55abab.textContent = _0x5c9470;
            const _0xe4eaca = document.createElement("span");
            _0xe4eaca.innerHTML = "&times;";
            _0xe4eaca.setAttribute("class", "chat-tab-close");
            _0xe4eaca.style.cssText = "margin-left:6px;cursor:pointer;font-size:12px;opacity:.85;";
            _0xe4eaca.onclick = function(_0x1a216a) {
                _0x1a216a.stopPropagation();
                if (_0x55abab.parentNode) {
                    _0x55abab.parentNode.removeChild(_0x55abab);
                }
                delete _0xde408[_0x4a7f30];
                if (!(2 != _0xd835b8 || !_0x1723aa || _0x1723aa.toLowerCase() != _0x4a7f30)) {
                    if (_0x1a216a = document.getElementById("chtTabPublic")) {
                        updateTab(_0x1a216a);
                    }
                }
            };
            _0x55abab.appendChild(_0xe4eaca);
...
function _0x3d16b2(_0xd33a46) {
    if (_0x544018 && 0 == _0xd33a46.button) {
        _0x544018 = false;
...
function _0xc55078(_0x132deb) {
    ...
    _0x6da0af();
    _0x35fff4(_0x132deb);
    _0x38c122 = setInterval(_0x5d12b6, FRAMERATE);
    _0x5d12b6();
...
function _0x71452a(_0x51c52b) {
    ...
    _0x6da0af();
    _0x35fff4(_0x51c52b);
    _0x38c122 = setInterval(_0x3d19d2, FRAMERATE);
    _0x3d19d2();
...
function _0x405de7(_0x35d9de) {
    ...
    for (var _0x576d9f = 0; _0x576d9f < _0x35d9de.changedTouches.length; _0x576d9f++) {
        ...
        if (_0x1c0802 == _0x54d5e9.identifier && !_0x3e08c0) {
            ...
            if (isSpectating && (_0xce750 = Math.min(clientWidth, clientHeight) / 2) * _0xce750 < _0x54d5e9) {
...
function _0x462522() {
    _0x36887a = 2 * _0xff0f52.x * _0x29f519 / _0x4d2bd2 + clientWidth / 2;
    _0x19f1c7 = 2 * _0xff0f52.y * _0x29f519 / _0x4d2bd2 + clientHeight / 2;
    _0x368208();
}
...
function _0x28c1e5() {
    _0x21548d = _0x34f96a / _0x3e50d9 + viewX - _0x2263d7;
    _0x1598a0 = _0x5079ce / _0x3e50d9 + viewY - _0x223539;
}
...
function _0x368208() {
    X = viewX + _0x36887a / _0x3e50d9 - _0x2263d7;
    Y = viewY + _0x19f1c7 / _0x3e50d9 - _0x223539;
}
...
function _0x411213(_0x9db3a7) {
    $.post("ag219.php", {
        ...
        if (_0x1579ab) {
            ...
            curserMessage("Unable to connect. Please refresh your browser and try again. If this persists, please send an email to hello@agma.io to inform", false, true, 0, 0);
        }
    }, "text");
}
...
function wsConnect() {
    ...
    if (windowIsLoaded && _0x256390 && (_0x13d7e0(), 0 != _0x2b8278)) {
        if (!ws) {
            ...
            // _0x1d3023 = setTimeout(wsConnect, _0xf1d309);
            // _0xf1d309 *= 1.5;
        }
    }
}
...
function _0x564895(_0x98e624) {
    ...
    if (isReady()) {
        ...
        curserMessage("<span style='opacity:0;'>." + _0x3d3bd2 + "</span>Connecting" + _0x3d3bd2 + "<span style='opacity:1;font-size:12px;margin-left:10px;'>(If any issues with connection, please email hello@agma.io)</span>", true, true, 2, 0);
...
function wsOnOpen() {
    ...
    _0x410ac6.setUint8(245).setUint16(62).setUint16(158).setUint32(_0x556e60).setUint32(_0xf937a3(_0x410ac6.buffer, 0, 9, 245)).send(true);
...
function _0x215896() {
    ...
    _0x587d52 = FRAMERATE / Math.clamp(currentFrameTime - _0x2d2df0, 1, 1000);
    _0x2d2df0 = currentFrameTime;
    for (var i = 0; i < 3; i++) {
        var _0x20e99f = [_0x463a1e, _0x2032b6, _0x5bdc9e][i];
        var _0x3443c2 = [_0x49dbad, _0x4df025, _0x59222b][i];
        for (var j = 0; j < _0x20e99f.length; j++) {
            var _0x44eb04 = _0x20e99f[j];
            var _0x2db68f = _0x3443c2[_0x44eb04];
            if (_0x2db68f) {
                for (var k = 0; k < _0x2db68f.length; k++) {
                    var _0x49c157 = _0x2db68f[k];
                    var _0x416df3 = playerEmotes[_0x49c157.id];
                    if (_0x416df3.time() >= _0x49c157.start + _0x416df3.duration) {
                        _0x2db68f.splice(k, 1);
                        k--;
                    }
                }
                if (0 == _0x2db68f.length) {
                    _0xfb52a(i, _0x44eb04);
                    _0x2db68f = null;
                }
            }
            if (!_0x2db68f) {
                _0x20e99f.splice(j, 1);
                j--;
            }
        }
    }
    ...
    _0x417591 = null;
    _0x41e1d9();
    _0x2c9685 = 9 * _0x587d52;
    _0x3e50d9 = (_0x2c9685 * _0x3e50d9 + _0xd28f67) / (_0x2c9685 + 1);
    _0x2263d7 = clientWidth / 2 / _0x3e50d9;
    _0x223539 = clientHeight / 2 / _0x3e50d9;
    var _0x514393 = mainPlayerCells.length;
    if (0 < _0x514393) {
        var _0x539378;
        var _0x39a721 = 0;
        var _0x106ce1 = 0;
        for (var _0x2b0b8e = 0; _0x2b0b8e < _0x514393; _0x2b0b8e++) {
            if ((_0x539378 = mainPlayerCells[_0x2b0b8e]).shouldUpdate) {
                _0x539378.updatePos();
            }
        ...
        _0x1e72ef(currentFrameTime);
    }
    viewX = ((_0x2c9685 = 3 * _0x587d52) * viewX + _0x53b8b0) / (_0x2c9685 + 1);
    viewY = (_0x2c9685 * viewY + _0x464afc) / (_0x2c9685 + 1);
            ...
            if (_0x634c41) {
                if (0 < _0x634c41.length) {
                    ...
                    for (_0x1e1569 = _0x1fd0b5 = _0x416571 = _0x40d243 = 0; _0x1e1569 < _0x634c41.length; ++_0x1e1569) {
                        ...
                        _0x5e49f7.beginPath();
                        _0x5e49f7.moveTo(_0x139239 / 2 / _0x2d45ca, 140);
                        _0x5e49f7.arc(_0x139239 / 2 / _0x2d45ca, 140, 80, _0x1fd0b5, _0xf261be, false);
                        _0x5e49f7.fill();
                        _0x1fd0b5 = _0xf261be;
                ...
                if (_0x15f2d8) {
                    ...
                    if (_0x15f2d8.wears && gameSettings.sWearables) {
                        for (_0x3ea109 = 0; _0x3ea109 < _0x15f2d8.wears.length; _0x3ea109++) {
                            var _0x2e4d3d;
                            var _0x2a2cb4;
                            var _0x168ad3 = _0x15f2d8.wears[_0x3ea109];
                            if (!(_0x2e4d3d = wearablesAndObjectsImages["W" + _0x168ad3.wearId + "_lo"])) {
    ...
    if (0 != _0xe31aef && _0xe31aef <= currentFrameTime) {
        _0x243b5e = _0x36887a;
        _0x4d7270 = _0x19f1c7;
        if (!(_0x3e08c0 || _0x10e53d || selectedMessage)) {
    ...
    if (_0x4cb089 && _0x2332bb && ((() => {
            ...
            var _0x4f2a5f;
            var _0x546ce1;
            var _0x8e2e84 = ~~(Math.max(_0x1afc1f * Math.min(1.6 * clientHeight, clientWidth, 1400) / 1400, 8) + 0.5);
            var _0x5952c4 = _0x8e2e84 / _0x1afc1f;
            var _0x1ee7cb = Math.min(12, Math.max(~~((clientHeight - 132) / ~~(20 * _0x5952c4 + 0.5)), 3));
            var _0x2f227f = [];
            ...
            if (gameSettings.sChat && 0 < _0x47744f) {
                ...
                for (var _0x461e7e = 0; _0x461e7e < _0x47744f; _0x461e7e++) {
                    ...
                    if (null == _0x53a19d.cache) {
                        ...
                        if (2 == _0x53a19d.shout) {
                            _0x587292.push(13);
                        } else if (_0x53a19d.shout) {
                            _0x587292.push(0);
                        }
                        if (4 == _0x53a19d.category) _0x587292.push(14);
                        if (!(1 != _0x53a19d.category && 2 != _0x53a19d.category)) _0x587292.push(1 == _0x53a19d.category ? 1 : 2);
                        if (!(1 != _0x53a19d.moderator && 2 != _0x53a19d.moderator)) _0x587292.push(1 == _0x53a19d.moderator ? 4 : 3);
                        if (_0x53a19d.goldMember) _0x587292.push(5);
                        if (_0x53a19d.donator) _0x587292.push(1 == _0x53a19d.donator ? 6 : 2 == _0x53a19d.donator ? 7 : 4 == _0x53a19d.donator ? 11 : 5 == _0x53a19d.donator ? 12 : 6 == _0x53a19d.donator ? 15 : 8);
                        if (_0x53a19d.yt) _0x587292.push(9);
                        if (_0x53a19d.touchUser) _0x587292.push(10);
                        _0x53a19d.cache = {
                            "displayName": _0x53a19d.name,
                            "parsedMessage": _0x4aac3c,
                            "emo": _0x67fcf,
                            "icons": _0x587292,
                            "width0": 0,
                            "width1": 0,
                ...
                for (_0x461e7e = _0x47744f - 1; 0 <= _0x461e7e; _0x461e7e--) {
                    ...
                    if (_0x53a19d.filter && ~~_0x290625 <= ++_0x232de1 - 1) {
                        ...
                        _0x4f2a5f = _0x56941e.hovered;
                        _0x546ce1 = _0x56941e.selected;
                        _0x56941e.hovered = _0x53a19d === _0x10e53d;
                        _0x56941e.selected = _0x53a19d === selectedMessage;
                        if (null == _0x56941e.canvas) {
                            _0x56941e.canvas = document.createElement("canvas");
                            _0x56941e.ctx = _0x56941e.canvas.getContext("2d");
                            _0x56941e.needsRedraw = true;
                        } else {
                            _0x56941e.needsRedraw = _0x56941e.drawn < 3 || !_0x56941e.complete || _0x56941e.color2 != _0x11e944 || _0x56941e.drawn % 30 == 0 || _0x56941e.hovered != _0x4f2a5f || _0x56941e.selected != _0x546ce1 || _0x56941e.canvas.width < ~~(Math.min(_0x56941e.width0 + _0x56941e.width1 + _0x56941e.width2, clientWidth - 10) * _0x358119 + 0.5) || 0.001 < Math.abs(_0x56941e.scale - _0x5952c4) || 0.001 < Math.abs(_0x56941e.dpr - _0x358119);
                        }
                        if (_0x56941e.needsRedraw) {
                            var _0x4e5846 = 0;
                            for (var _0x5b4ab7 = _0x56941e.emo; _0x4e5846 < _0x5b4ab7.length; _0x4e5846++) {
                                (_0x366a09 = _0x5b4ab7[_0x4e5846]).x0 = _0x44020a.measureText(_0x56941e.parsedMessage.substring(0, _0x366a09.pos)).width;
                            }
                            _0x56941e.canvas.height = Math.max(~~(23 * _0x5952c4 * _0x358119 + 0.5), 1);
                            _0x56941e.width0 = _0x56941e.icons.length * ~~(22 * _0x5952c4 + 0.5);
                            _0x56941e.width1 = ~~((_0x56941e.displayName ? _0x44020a.measureText(_0x56941e.displayName).width + 6 * _0x5952c4 : 2 * _0x5952c4) + 0.5);
                            if (_0x56941e.width1 > ~~(400 * _0x5952c4)) {
                                _0x56941e.width1 = ~~(400 * _0x5952c4);
                                _0x56941e.clip1 = true;
                            }
                            _0x56941e.width2 = ~~(_0x44020a.measureText(_0x56941e.parsedMessage).width + 6 * _0x5952c4 + 0.5);
                        ...
                        if (_0x74f54b < _0x56941e.width0 + _0x56941e.width1 + _0x56941e.width2) {
                            _0x74f54b = _0x56941e.width0 + _0x56941e.width1 + _0x56941e.width2;
                        }
            ...
            if (0 < _0x232de1) {
                ...
                _0x4f2a5f = Math.min(_0x74f54b, clientWidth - (_0x1afc1f ? 25 : 10));
                ...
                for (_0x461e7e = 0; _0x461e7e < _0x232de1; _0x461e7e++) {
                    if ((_0x56941e = (_0x53a19d = _0x2f227f[_0x461e7e]).cache).needsRedraw) {
                        _0x56941e.canvas.width = Math.max(~~(Math.min(_0x56941e.width0 + _0x56941e.width1 + _0x56941e.width2, clientWidth - 10) * _0x358119 + 0.5), 1);
                        _0x56941e.complete = true;
                        var _0x20347b;
                        var _0x4f84bc = _0x56941e.ctx;
                        _0x4f84bc.scale(_0x358119, _0x358119);
                        if (_0x56941e.hovered || _0x56941e.selected) {
                            _0x4f84bc.globalAlpha = _0x56941e.selected ? 0.9 : 0.4;
                            _0x4f84bc.fillStyle = "#999999";
                            _0x4f84bc.fillRect(0, 0, ~~(Math.max(_0x56941e.width0 + _0x56941e.width1 + _0x5952c4, 10 * _0x5952c4) + 0.5), ~~(23 * _0x5952c4 + 0.5));
                        }
                        _0x4f84bc.font = _0x8e2e84 + "px Ubuntu";
                        _0x4f84bc.globalAlpha = 1;
                        if (0 < _0x56941e.icons.length) {
                            if ((_0x20347b = chaticonsImage) && _0x20347b.complete && 0 != _0x20347b.width) {
                                var _0x4e5846 = 0;
                        ...
                        if (_0x56941e.clip1) {
                            _0x4f84bc.save();
                            _0x4f84bc.beginPath();
                            _0x4f84bc.rect(_0x56941e.width0, 0, _0x56941e.width1, ~~(23 * _0x5952c4 + 0.5));
                            _0x4f84bc.clip();
                        }
                        _0x4f84bc.strokeText(_0x56941e.displayName, _0x56941e.width0 + ~~(3 * _0x5952c4 + 0.5), ~~(17 * _0x5952c4 + 0.5));
                        _0x4f84bc.fillText(_0x56941e.displayName, _0x56941e.width0 + ~~(3 * _0x5952c4 + 0.5), ~~(17 * _0x5952c4 + 0.5));
                        if (_0x56941e.clip1) {
                            _0x4f84bc.restore();
                        }
                        _0x4f84bc.fillStyle = _0x56941e.color2;
                        _0x4f84bc.fillText(_0x56941e.parsedMessage, _0x56941e.width0 + _0x56941e.width1 + ~~(3 * _0x5952c4 + 0.5), ~~(17 * _0x5952c4 + 0.5));
                        if (0 < _0x56941e.emo.length) {
                            if ((_0x20347b = emojisheetEmotes) && _0x20347b.complete && 0 != _0x20347b.width) {
                                _0x4e5846 = 0;
                                for (_0x5b4ab7 = _0x56941e.emo; _0x4e5846 < _0x5b4ab7.length; _0x4e5846++) {
                                    var _0x366a09 = _0x5b4ab7[_0x4e5846];
                                    _0x4f84bc.drawImage(_0x20347b, _0x366a09.index % 8 * 20, 20 * ~~(_0x366a09.index / 8), 20, 20, ~~(_0x56941e.width0 + _0x56941e.width1 + 2 * _0x5952c4 + _0x366a09.x0 + 0.5), 0, ~~(20 * _0x5952c4 + 0.5), ~~(20 * _0x5952c4 + 0.5));
                                }
                            } else {
                                _0x56941e.complete = false;
                            }
                    ...
                    if (_0x53a19d.selectable) {
                        _0x1937c1.push({
                            "ch": _0x53a19d,
                            "x0": 0,
                            "y0": _0x4f2a5f + _0x5952c4,
                            "x1": Math.max(_0x56941e.width0 + _0x56941e.width1 + _0x5952c4, 10 * _0x5952c4),
    ...
    if (_0x3b1e5e) {
        if (_0x4d7270) {
            ...
            if (null == _0x3a579c) {
                ...
                _0x46d4aa[_0x965bf3 + "2"] = newCanvasImage("img/" + _0x965bf3 + "2.png");
                _0x46d4aa[_0x965bf3 + "4"] = newCanvasImage("img/" + _0x965bf3 + "4.png");
                _0x46d4aa[_0x965bf3 + "8"] = newCanvasImage("img/" + _0x965bf3 + "8.png");
                _0x46d4aa[_0x965bf3 + "16"] = newCanvasImage("img/" + _0x965bf3 + "16.png");
                _0x46d4aa[_0x965bf3 + "32"] = newCanvasImage("img/" + _0x965bf3 + "32.png");
    ...
    _0xb14342.fillRect(0, 0, clientWidth, clientHeight);
    if (_0x3b1e5e) {
        if (_0x4d7270 || _0xccf34) {
            ...
            var _0x3c5dfa = (-viewX + _0x2263d7) % (_0x3a579c.width * _0x330e7f);
            var _0x31da46 = (-viewY + _0x223539) % (_0x3a579c.height * _0x330e7f);
            var _0x2058b6 = 0;
            var _0x20b8b1 = 0;
            var _0x5b5b68 = clientWidth / _0x3e50d9;
            var _0x547c24 = clientHeight / _0x3e50d9;
            if (0 < _0x3c5dfa) {
            ...
            if (gameSettings.sCustomBackClip) {
                _0x2058b6 = Math.max(_0x2058b6, -viewX + _0x2263d7 + mapInfos.left);
                _0x20b8b1 = Math.max(_0x20b8b1, -viewY + _0x223539 + mapInfos.top);
                _0x5b5b68 = Math.min(_0x5b5b68, -viewX + _0x2263d7 + mapInfos.right) - _0x2058b6;
                _0x547c24 = Math.min(_0x547c24, -viewY + _0x223539 + mapInfos.bottom) - _0x20b8b1;
            }
            ...
            if (_0x90bd87 || _0x5bd130) {
                ...
                var _0x965bf3 = (viewX - _0x2263d7 - _0x5c1aa9) * _0x3a579c.width / _0x3c5dfa;
                var _0x3b1e5e = (viewY - _0x223539 - _0x4ba286) * _0x3a579c.height / _0x31da46;
                var _0x4d7270 = clientWidth / _0x3e50d9 * _0x3a579c.width / _0x3c5dfa;
                var _0x236d05 = clientHeight / _0x3e50d9 * _0x3a579c.height / _0x31da46;
                var _0x2058b6 = 0;
                var _0x20b8b1 = 0;
                var _0x5b5b68 = clientWidth;
                var _0x547c24 = clientHeight;
                if (_0x965bf3 < 0) {
                    _0x4d7270 += _0x965bf3;
                    _0x965bf3 = 0;
                    _0x5b5b68 -= _0x2058b6 = (-viewX + _0x2263d7 + _0x5c1aa9) * _0x3e50d9;
                }
                if (_0x3b1e5e < 0) {
                    _0x236d05 += _0x3b1e5e;
                    _0x3b1e5e = 0;
                    _0x547c24 -= _0x20b8b1 = (-viewY + _0x223539 + _0x4ba286) * _0x3e50d9;
                }
                if (_0x965bf3 + _0x4d7270 > _0x3a579c.width) {
                    _0x4d7270 = _0x3a579c.width - _0x965bf3;
                    _0x5b5b68 = (-viewX + _0x2263d7 + _0x3c5dfa + _0x5c1aa9) * _0x3e50d9 - _0x2058b6;
                }
                if (_0x3b1e5e + _0x236d05 > _0x3a579c.height) {
                    _0x236d05 = _0x3a579c.height - _0x3b1e5e;
                    _0x547c24 = (-viewY + _0x223539 + _0x31da46 + _0x4ba286) * _0x3e50d9 - _0x20b8b1;
                }
                if (_0x5bd130 && 1 == gameSettings.sCustomBackType && gameSettings.sCustomBackClip && 0 < _0x5b5b68 && 0 < _0x547c24 && (_0x62fded = (_0x28f6af - Math.max(_0x5c1aa9, viewX - _0x2263d7)) * _0x3e50d9, _0x4f95d4 = (_0x500945 - Math.max(_0x4ba286, viewY - _0x223539)) * _0x3e50d9, _0x62fded < _0x5b5b68 && (_0x4d7270 *= _0x62fded / _0x5b5b68, _0x5b5b68 = _0x62fded), _0x4f95d4 < _0x547c24)) {
                ...
                if (_0x5db90e) {
                    ...
                    var _0x31da46 = clientWidth / _0x3e50d9;
                    var _0x3c5dfa = clientHeight / _0x3e50d9;
                    var _0x4f95d4 = 200 * _0x243b5e;
                    _0xb14342.beginPath();
                    for (let _0x4d7c46 = (_0x2263d7 - viewX) % _0x4f95d4; _0x4d7c46 < _0x31da46; _0x4d7c46 += _0x4f95d4) {
                        _0xb14342.moveTo(_0x4d7c46, 0);
                        _0xb14342.lineTo(_0x4d7c46, _0x3c5dfa);
                    }
                    for (let _0x5d93ae = (_0x223539 - viewY) % _0x4f95d4; _0x5d93ae < _0x3c5dfa; _0x5d93ae += _0x4f95d4) {
    ...
    _0xb14342.save();
    if (mapInfos.draw && (_0x4f401c(currentFrameTime), _0x25fdfa = mapInfos.top > viewY - _0x223539 || mapInfos.right < viewX + _0x2263d7 || mapInfos.bottom < viewY + _0x223539 || mapInfos.left > viewX - _0x2263d7)) {
        _0xb14342.beginPath();
        _0xb14342.rect(0, 0, clientWidth, clientHeight);
        _0xb14342.rect(Math.max(mapInfos.left - viewX + _0x2263d7, 0) * _0x3e50d9, Math.max(mapInfos.top - viewY + _0x223539, 0) * _0x3e50d9, (Math.min(mapInfos.right, viewX + _0x2263d7) - Math.max(mapInfos.left, viewX - _0x2263d7)) * _0x3e50d9, (Math.min(mapInfos.bottom, viewY + _0x223539) - Math.max(mapInfos.top, viewY - _0x223539)) * _0x3e50d9);
        _0xb14342.globalAlpha = 0.3;
        _0xb14342.fillStyle = "#CC3030";
        _0xb14342.fill("evenodd");
    }
    _0xb14342.scale(_0x3e50d9, _0x3e50d9);
    _0xb14342.translate(-viewX + _0x2263d7, -viewY + _0x223539);
    ...
    var _0x53754a;
    var _0x19c7c3;
    var _0x1a33c5 = deletedFood.length;
    for (var i = 0; i < _0x1a33c5; i++) {
        (_0x53754a = deletedFood[i]).drawCell();
        if (2 === _0x53754a.destroyed) {
    ...
    if (_0x5ae1b6 = (() => {
            var _0x1fa510 = 0;
            for (var _0x1614fd = 0; _0x1614fd < mainPlayerCells.length; _0x1614fd++) {
                var _0x41ff06 = mainPlayerCells[_0x1614fd];
        ...
        if (_0x2332bb) {
            _0x3a579c = Math.max(Math.min(1.6 * clientHeight, clientWidth, 1400) / 1400, 0.5);
            ...
            _0xb14342.globalAlpha = 1;
            _0xb14342.drawImage(_0x12c6d8, 12, (_0x4386c1 ? 60 : 80) - ~~(16 * _0x3a579c + 0.5), _0x12c6d8.width / _0x351ad0.scale, _0x12c6d8.height / _0x351ad0.scale);
        }
    }
    if (_0x4400ec && (_0x13a1ae = fixedMouseImage) && _0x13a1ae.complete && 0 != _0x13a1ae.width) {
        _0xb14342.globalAlpha = 1;
        _0xb14342.drawImage(_0x13a1ae, (_0x312d0a - viewX + _0x2263d7) * _0x3e50d9 - 20, (_0x2435c4 - viewY + _0x223539) * _0x3e50d9 - 10, 50, 50);
    }
    if (_0x181957 && (
        _0x28c1e5(),
        _0x114a07 && (
            ...
            _0x114a07.nSize != _0x4289a6 && 0 != _0x4289a6 && (
                _0x114a07.size = _0x114a07.oSize = _0x114a07.nSize = _0x114a07.strokeSize = _0x4289a6,
                _0x114a07.be = null,
                _0x114a07.sizeScale = 0
            ),
            _0x34eb69 = 4 == _0x114a07.type ? 0.83 * _0x114a07.size : _0x114a07.size,
            _0x51f702 = 0 == _0x489844 && _0x496adb && 0 != _0x4289a6 && _0x114a07.sizeScale
                ? _0x34eb69 * _0x3e50d9 < 4
                    ? 4 / _0x34eb69
                    : _0x3e50d9
                : (16 == _0x114a07.type ? 23 : 14) * (_0x4386c1 ? 0.7 : 1) / _0x34eb69,
            _0x2c9685 = +_0x587d52,
            ...
            _0xb14342.scale(_0x3e50d9, _0x3e50d9),
            _0xb14342.translate(-viewX + _0x2263d7, -viewY + _0x223539),
            false && _0x496adb && 0 == _0x489844 && ( // mobile
                _0xb14342.beginPath(),
        ...
        _0x4cb1e7 = null;
        for (_0x34eb69 = allNonFoodCells.length - 1; 0 <= _0x34eb69; _0x34eb69--) {
            if (0 == (_0x25fdfa = allNonFoodCells[_0x34eb69]).type) {
                var ox = _0x25fdfa.x - _0x21548d;
                var oy = _0x25fdfa.y - _0x1598a0;
                if (ox * ox + oy * oy < _0x25fdfa.size * _0x25fdfa.size) {
                    _0x4cb1e7 = _0x25fdfa;
                    break;
                }
            }
        ...
        if (_0x4cb1e7) {
            _0x4cb1e7.setAnimation({
                "id": 13,
                "start": playerEmotes[13].time(),
                "received": ++_0x57f5d0
            });
        }
    }
    if (_0x2c6f91 && gameSettings.sMinimap && _0x12af20) {
        var _0x34eb69;
        var _0x13a1ae;
        var _0x270f24 = _0x51f702 = ~~(200 * (_0x34eb69 = ~~(Math.max(200 * Math.min(1.6 * clientHeight, clientWidth, 1400) / 1400, 90) + 0.5) / 200) + 0.5);
        if (!_0x4b4b51) {
        ...
        if (!(!_0xaade67 && _0x4b4b51.complete)) {
            ...
            _0x1138be.globalAlpha = 0.9;
            _0x1138be.fillStyle = "#000000";
            _0x1138be.fillRect(0, 0, _0x51f702, _0x51f702);
            if ((_0x13a1ae = null == (_0x13a1ae = wearablesAndObjectsImages.minimap) ? wearablesAndObjectsImages.minimap = newImage("img/minimap.png") : _0x13a1ae) && _0x13a1ae.complete && 0 != _0x13a1ae.width) {
        ...
        _0x25fdfa = _0x51f702 * _0x51f702 * clientWidth * clientHeight / (_0x3e50d9 * _0x3e50d9 * 200 * 200 * _0x34eb69 * _0x34eb69);
        ...
        _0x5be4cd.fillRect(viewX - _0x2263d7, viewY - _0x223539, clientWidth / _0x3e50d9, clientHeight / _0x3e50d9);
        _0x39d073(_0x5be4cd, _0x51f702);
        _0x476ebb = allFoodCells.length;
        for (i = 0; i < _0x476ebb; i++) {
            _0x2c9685 = allFoodCells[i];
            if (!(!_0x2c9685.shouldUpdate || _0x2c9685.x == _0x2c9685.hx && _0x2c9685.y == _0x2c9685.hy))
                _0x2c9685.drawMinimapCell(_0x51f702);
        }
        _0x476ebb = allNonFoodCells.length;
        for (i = 0; i < _0x476ebb; i++) {
            _0x2c9685 = allNonFoodCells[i];
    ...
    for (_0x19c7c3 in _0x34a1ac) {
        ...
        for (_0x91d784 in _0x26362e)
            if (5000 <= currentFrameTime - _0x26362e[_0x91d784].timestamp) {
    ...
    if (15 < (_0x547c24 = Date.now() - currentFrameTime)) {
        _0xb66c8e -= 0.01;
    }
    if (13.333 < _0x547c24) {
        _0x10d812 += 0.1;
...
function wsOnClose() {
    ...
    _0x30cebd();
    _0x26af75();
    if (0 != fallbackGameservers.length) {
        _0x40966e = fallbackGameservers.shift();
        ...
        if (window.localStorage.gameservers && window.localStorage.serverlistVersion != 12) {
            _0x256390 = null;
            _0x46c79d = '';
            connectDefault();
        } else {
...
window.azad = function(_0x1f19f5, _0x2aa3d0) {
    if ((
        ...
        _0x1f19f5 = (
            !_0x2a60cc &&
            0 == mainPlayerCellsIds.length &&
            !_0x1fc846 &&
            _0x3e08c0 != _0x1f19f5 ? true : _0x1f19f5
        )
    )) {
        az(_0x2aa3d0, 2);
    }
...
class Cell {
    constructor(id, x, y, size) {
        ...
        this.ox = this.x = x;
        this.oy = this.y = y;
        this.oSize = this.size = this.strokeSize = size;
        this.name = null;
        this.namePart = null;
        this.clanPart = null;
        this.nameSize = 0;
        ...
        this.ownCell = false;
        this.type = -1;
        this.smallFood = false;
        this.shape = 0;
        this.rotation = 0;
        this.orientation = 0;
        this.colorIndexName = 0;
        this.isMinion = false;
        this.sameParty = false;
        this.isGhosted = false;
        this.isCloaked = false;
        this.coronaSpikes = false;
        this.stars = 0;
        this.touchUser = 0;
    }
    parseName(_0xa53980) {
    ...
    calcPins() {
        ...
        var _0x145478 = !gameSettings.sClassicViruses && 2 == this.spiked;
        var _0x1dd76f = 4 == this.type ? 0.83 * this.size : this.size;
        ...
        if (_0x4c019b.p != (_0x4433fd = 30 < _0x4433fd ? _0x4433fd < 1000 ? 2 * ~~(_0x4433fd / 2) : 1000 : 30) || 0 != ~~(_0x4c019b.s - _0x1dd76f) || 0 != ~~(_0x4c019b.x - this.x) || 0 != ~~(_0x4c019b.y - this.y)) {
            if (9 == this.type && 0 != ~~(_0x4c019b.s - _0x1dd76f) && 0 != this.id && (this.rotation += Math.PI / (this.size * _0x587d52), this.rotation > Math.PI)) {
                this.rotation -= 2 * Math.PI;
            }
            var _0x1fba2e;
            var _0x4611e3;
            var _0x53c65a = this.Ne;
            var _0x43fac2 = 2 == this.spiked ? 10000 * (this.rotation / (2 * Math.PI) + 1) + 0.5 : 0.5;
            ...
            this.strokeSize = _0x1affee;
        }
    }
    destroy(_0x445cfe) {
        var _0x54a02f;
        if (this.smallFood) {
            allFoodCells.remove(this);
        } else {
            allNonFoodCells.remove(this);
            if (0 === this.type) {
                if (this.ownCell && mainPlayerCells.remove(this)) {
                    _0x29246b = true;
                }
                mainPlayerCellsIds.remove(this.id);
                if ((_0x54a02f = (this.isMinion ? minionsByOid : playersByOid)[this.oid]) && (_0x54a02f.remove(this), 0 === _0x54a02f.length)) {
                    if (this.isMinion) {
                        delete minionsByOid[this.oid];
                    } else {
                        delete playersByOid[this.oid];
                    }
                }
                this.nameCache = null;
                this.clanCache = null;
        ...
        delete allCells[this.id];
        this.destroyed = 1;
        this.shouldUpdate = true;
        if (_0x445cfe && (gameSettings.sFood || !this.smallFood || _0x4400ec)) {
            deletedFood.push(this);
        }
    }
    updatePos() {
        var _0x270f49 = gameSettings.sSlowMotion ? 480 : 120;
        var _0x3f5582 = (currentFrameTime - this.updateTime) / _0x270f49;
        ...
        this.size = _0x332e49 * (this.nSize - this.oSize) + this.oSize;
        if (!(!this.be || 2 != this.type && 22 != this.type || (_0x4e56ee = this.x - _0x4e56ee, _0x2fa8fa = this.y - _0x2fa8fa, 0 == ~~_0x4e56ee && 0 == ~~_0x2fa8fa))) {
        ...
        if (gameSettings.sSlowMotion && this.ga < 1) {
            _0x3f5582 = (currentFrameTime - this.createTime) / _0x270f49;
            this.ga = _0x3f5582 < 0 ? 0 : 1 < _0x3f5582 ? 1 : _0x3f5582;
        }
        if (1 <= _0x332e49 && (this.shouldUpdate = false, 1 === this.destroyed)) {
            this.destroyed++;
        }
        return _0x332e49;
    }
    drawCell() {
        var _0x282a29 = (this.wears && gameSettings.sWearables ? 2.5 * this.size : this.size) + 40;
        if (
            !gameSettings.sFood && this.smallFood && (!this.shouldUpdate || this.x == this.hx && this.y == this.hy) && !_0x4400ec ||
            this.x + _0x282a29 < viewX - _0x2263d7 ||
            this.y + _0x282a29 < viewY - _0x223539 ||
            this.x - _0x282a29 > viewX + _0x2263d7 ||
            this.y - _0x282a29 > viewY + _0x223539
        ) {
            if (this.shouldUpdate && (this.updatePos(), 1 != this.type)) {
                this.be = null;
                this.strokeSize = 4 == this.type ? 0.83 * this.size : this.size;
            }
        } else {
            if (!gameSettings.sFoodHalf || !this.smallFood || -1 != this.shouldDraw) {
                var _0x222c9e = gameSettings.sLineShapes && 2 == this.shape;
                var _0x683945 = gameSettings.sPolygonShapes && 3 <= this.shape || _0x222c9e;
                var _0x2c5c7d = !this.spiked || !gameSettings.sCellSpikes || _0x683945 || _0x3e50d9 < (gameSettings.sClassicViruses || 2 != this.spiked ? 0.2 : 0.06) && 0 != this.id;
                var _0x58ffc6 = this.shouldUpdate ? this.updatePos() : 1;
                var _0x33867d = false;
                ...
                if (1 != this.type) {
                    ...
                    } else if (!(this.be || (_0x433539 = 4 == this.type ? 0.83 * this.size : this.size, this.be = {
                            "x": 0,
                            "y": 0,
                            "s": _0x433539,
                            "p": 0
                    ...
                    if (this.anim) {
                        for (_0x433539 = 0; _0x433539 < this.anim.length; _0x433539++) {
                            switch ((_0x282a29 = this.anim[_0x433539]).id) {
                                case 3:   this.spin(_0x282a29);          break;
                                case 6:   this.flip(_0x282a29);          break;
                                case 7:   this.flipCoin(_0x282a29);      break;
                                case 8:   this.shake(_0x282a29);         break;
                                case 11:  this.jump(_0x282a29);          break;
                                case 90:  this.orbit(_0x282a29);         break;
                                case 91:  this.wobble(_0x282a29);        break;
                                case 92:  this.pulseDance(_0x282a29);    break;
                                case 93:  this.driftWave(_0x282a29);     break;
                                case 94:  this.quakeDance(_0x282a29);    break;
                                case 95:  this.swayDance(_0x282a29);     break;
                                case 96:  this.jellyDance(_0x282a29);    break;
                                case 97:  this.moonwalkDance(_0x282a29); break;
                                case 98:  this.helixDance(_0x282a29);    break;
                                case 99:  this.hiccupDance(_0x282a29);   break;
                                case 102: this.slinkyDance(_0x282a29);   break;
                                case 103: this.vortexDance(_0x282a29);   break;
                                case 104: this.glitchDance(_0x282a29);   break;
                            }
                            if (0 == _0x282a29.id) {
                                this.anim.splice(_0x433539, 1);
                                _0x433539--;
                            }
                        }
                        for (_0x433539 = 0; _0x433539 < this.anim.length; _0x433539++) {
                            if (15 === (_0x282a29 = this.anim[_0x433539]).id) {
                                this.drawSpeed(_0x282a29, _0xb14342, _0x1b2b2f, _0x52fc0c);
                            }
                            if (0 == _0x282a29.id) {
                                this.anim.splice(_0x433539, 1);
                                _0x433539--;
                ...
                if (_0x2c5c7d) {
                    if (0 == this.type && _0x42a8fa) {
                        ...
                        this.strokeSize = (_0x433539 * this.strokeSize + (4 == this.type ? 0.83 * this.size : this.size)) / (_0x433539 + 1);
                    } else {
                    ...
                    if (_0x683945) {
                        ...
                        var _0x34c05a = this.strokeSize * cellStrokeSizeMultiplier[_0x282a29];
                        ...
                        if (this.coronaSpikes && gameSettings.sCellSpikes) {
                ...
                if (this.isCloaked ? this.ownCell || _0x4400ec : _0x282a29 && (gameSettings.sCellBorders || this.spiked) || _0x222c9e) {
                    _0x433539 = this.ga;
                    _0xb14342.globalAlpha = this.destroyed ? _0x433539 * (1 - _0x58ffc6) : _0x433539;
                    _0xb14342.lineWidth = this.isCloaked && (this.ownCell || _0x4400ec) ? 30 : this.smallFood ? 4 : gameSettings.sBubbleCells ? this.spiked || 25 < this.size ? 6 : 4 : this.spiked && this.size < 80 ? 8 : 10;
                    _0xb14342.lineJoin = this.spiked && (gameSettings.sClassicViruses || 2 != this.spiked || this.size < 70) ? "miter" : "round";
                    _0xb14342.strokeStyle = this.isCloaked && (this.ownCell || _0x4400ec) ? gameSettings.sDark ? "#333333" : "#DDDDDD" : this.isGhosted || !gameSettings.sColors ? "#AAAAAA" : gameSettings.sBubbleCells ? this.color : this.colorDimmed;
                    _0xb14342.stroke();
                }
                if (1 != this.type) {
                    ...
                    if (this.wears && gameSettings.sWearables && !this.isGhosted) {
                    ...
                    if (this.anim) {
                        for (_0x433539 = 0; _0x433539 < this.anim.length; _0x433539++) {
                            switch ((_0x282a29 = this.anim[_0x433539]).id) {
                                case 2:
                                    this.drawHighlight(_0x282a29, _0xb14342, _0x1b2b2f, _0x52fc0c);
                                    break;
                                case 9:
                                    this.drawHit(_0x282a29, _0xb14342, _0x1b2b2f, _0x52fc0c);
                                    break;
                                case 13:
                                    this.drawDragOver(_0x282a29, _0xb14342, _0x1b2b2f, _0x52fc0c);
                                    break;
                                case 16:
                                    this.drawCloakHighlight(_0x282a29, _0xb14342, _0x1b2b2f, _0x52fc0c);
                                    break;
                                case 4:
                                case 5:
                                case 10:
                                ...
                                case 56:
                                case 17:
                                    this.drawSprites(_0x282a29, _0xb14342, _0x1b2b2f, _0x52fc0c);
                            }
                            if (0 == _0x282a29.id) {
                                this.anim.splice(_0x433539, 1);
                                _0x433539--;
                        ...
                        for (_0x433539 = 0; _0x433539 < this.anim.length; _0x433539++) {
                            switch ((_0x282a29 = this.anim[_0x433539]).id) {
                                case 1:
                                    this.drawFlash(_0x282a29, _0xb14342, _0x1b2b2f, _0x52fc0c);
                                    break;
                                case 18:
                                    this.drawBlast(_0x282a29, _0xb14342, _0x1b2b2f, _0x52fc0c);
                            }
                            if (0 == _0x282a29.id) {
                                this.anim.splice(_0x433539, 1);
                                _0x433539--;
                    ...
                    if (
                        ...
                        if (this.textDrawn || _0x164fe5 == this) {
                            ...
                            this.drawText(_0xb14342, _0x1b2b2f, _0x52fc0c, _0x2c5c7d, _0x222c9e);
                            this.textDrawn = true;
                        } else {
                            _0x417591 = this;
                        }
    ...
    setAnimation(_0xb44e93) {
        if (1 != this.type) {
            _0xb44e93 = {
                "id": _0xb44e93.id,
                "start": _0xb44e93.start,
                "received": _0xb44e93.received
            };
            if (this.anim) {
                for (var i = 0; i < this.anim.length; i++) {
                    if (this.anim[i].received > _0xb44e93.received) {
                        this.anim.splice(i, 0, _0xb44e93);
                        return void(this.anim.length > 3 && this.anim.splice(this.anim.length - 2, 1)); // FIXME: make this already infinite stack
                    }
                }
                if (this.anim.length < 3) {
                    this.anim.push(_0xb44e93);
                } else {
                    this.anim[this.anim.length - 1] = _0xb44e93;
                }
            } else {
                this.anim = [_0xb44e93];
            }
    ...
    clearAnimation(_0x36ff46) {
        if (this.anim) {
            if (0 == _0x36ff46) {
                this.anim = null;
            } else {
                for (var i = 0; i < this.anim.length; i++) {
                    if (this.anim[i].id == _0x36ff46) {
    ...
    spin(_0x9bfc0d) {
        var _0x59765d = (currentFrameTime - _0x9bfc0d.start) / playerEmotes[_0x9bfc0d.id].duration;
    ...
    flip(_0x407aa8) {
        var _0x343225 = (currentFrameTime - _0x407aa8.start) / playerEmotes[_0x407aa8.id].duration;
    ...
    flipCoin(_0x4275c7) {
        ...
        if (this.destroyed) {
            ...
            if (1 <= (_0x4ef9c8 = (currentFrameTime - _0x4275c7.start) / 2000)) {
                _0x4275c7.start += 2000;
                _0x4ef9c8 %= 1;
            }
    ...
    shake(_0x2e6f39) {
        var _0x1fec16 = (currentFrameTime - _0x2e6f39.start) / playerEmotes[_0x2e6f39.id].duration;
    ...
    jump(_0x380f23) {
        var _0x3ee1c2 = (currentFrameTime - _0x380f23.start) / (playerEmotes[_0x380f23.id].duration - this.id % 20 * 20);
        if (1 <= (_0x3ee1c2 = _0x3ee1c2 < 0 ? 0 : 1 < _0x3ee1c2 ? 1 : _0x3ee1c2)) {
            if (1 <= (_0x3ee1c2 = (currentFrameTime - _0x380f23.start) / playerEmotes[_0x380f23.id].duration)) {
                _0x380f23.id = 0;
            }
        } else {
            var _0x312e2f;
    ...
    orbit(_0x682ae7) {
        ...
        if (1 <= (_0x35bfd8 = _0x35bfd8 < 0 ? 0 : 1 < _0x35bfd8 ? 1 : _0x35bfd8)) {
            ...
            _0x5a632f = this.getTransform();
            _0x682ae7 = _0x35bfd8 * Math.PI * 8;
            _0x35bfd8 = Math.max(24, 0.22 * this.size) * (1 - 0.35 * _0x35bfd8);
            if (gameSettings.sGraphics < 3 && gameSettings.sCellAnimations) {
                _0x5a632f.t = _0x5a632f.r = true;
            }
            _0x5a632f.tx += Math.cos(_0x682ae7) * _0x35bfd8;
            _0x5a632f.ty += Math.sin(_0x682ae7) * _0x35bfd8 * 0.65;
            _0x5a632f.rz += 0.06 * Math.sin(0.5 * _0x682ae7);
        }
    }
    wobble(_0x5c83e0) {
        var _0x1c792c;
        var _0x2d298c = (currentFrameTime - _0x5c83e0.start) / playerEmotes[_0x5c83e0.id].duration;
        if (1 <= (_0x2d298c = _0x2d298c < 0 ? 0 : 1 < _0x2d298c ? 1 : _0x2d298c)) {
            _0x5c83e0.id = 0;
        } else {
            _0x1c792c = this.getTransform();
            _0x5c83e0 = _0x2d298c * Math.PI * 12;
            _0x2d298c = 1 - 0.75 * _0x2d298c;
            if (gameSettings.sGraphics < 3 && gameSettings.sCellAnimations) {
                _0x1c792c.s = _0x1c792c.r = true;
            }
            _0x1c792c.rz += 0.07 * Math.sin(_0x5c83e0) * _0x2d298c;
            _0x1c792c.sx *= 1 + 0.045 * Math.sin(0.5 * _0x5c83e0) * _0x2d298c;
            _0x1c792c.sy *= 1 - 0.045 * Math.sin(0.5 * _0x5c83e0) * _0x2d298c;
        }
    }
    pulseDance(_0x58a97d) {
        var _0x13686c;
        var _0x32ffc1 = (currentFrameTime - _0x58a97d.start) / playerEmotes[_0x58a97d.id].duration;
        if (1 <= (_0x32ffc1 = _0x32ffc1 < 0 ? 0 : 1 < _0x32ffc1 ? 1 : _0x32ffc1)) {
            _0x58a97d.id = 0;
        } else {
            _0x13686c = this.getTransform();
            _0x58a97d = _0x32ffc1 * Math.PI * 18;
            _0x32ffc1 = 1 - 0.6 * _0x32ffc1;
            _0x32ffc1 = 1 + 0.22 * Math.max(-0.22, Math.sin(_0x58a97d)) * _0x32ffc1;
            if (gameSettings.sGraphics < 3 && gameSettings.sCellAnimations) {
                _0x13686c.s = true;
            }
            _0x13686c.sx *= _0x32ffc1;
            _0x13686c.sy *= 2 - _0x32ffc1;
        }
    }
    driftWave(_0x3b6a08) {
        var _0x3da7d6;
        var _0x1ba7e4;
        var _0x1bd13f = (currentFrameTime - _0x3b6a08.start) / playerEmotes[_0x3b6a08.id].duration;
        if (1 <= (_0x1bd13f = _0x1bd13f < 0 ? 0 : 1 < _0x1bd13f ? 1 : _0x1bd13f)) {
            _0x3b6a08.id = 0;
        } else {
            _0x3da7d6 = this.getTransform();
            _0x1ba7e4 = _0x1bd13f * Math.PI * 10;
            _0x3b6a08 = 1 - 0.5 * _0x1bd13f;
            _0x1bd13f = Math.max(18, 0.18 * this.size) * _0x3b6a08;
            if (gameSettings.sGraphics < 3 && gameSettings.sCellAnimations) {
                _0x3da7d6.t = _0x3da7d6.r = true;
            }
            _0x3da7d6.tx += Math.sin(_0x1ba7e4) * _0x1bd13f;
            _0x3da7d6.ty += Math.sin(2 * _0x1ba7e4) * _0x1bd13f * 0.35;
            _0x3da7d6.rz += 0.08 * Math.cos(_0x1ba7e4) * _0x3b6a08;
        }
    }
    quakeDance(_0xacd671) {
        var _0x155535;
        var _0x17e08e;
        var _0x425f14;
        var _0x32e705;
        var _0x64c2b9 = (currentFrameTime - _0xacd671.start) / playerEmotes[_0xacd671.id].duration;
        if (1 <= (_0x64c2b9 = _0x64c2b9 < 0 ? 0 : 1 < _0x64c2b9 ? 1 : _0x64c2b9)) {
            _0xacd671.id = 0;
        } else {
            _0x155535 = this.getTransform();
            _0x32e705 = (_0x425f14 = 6 * _0x64c2b9) - Math.floor(_0x425f14);
            _0x17e08e = 1 - 0.7 * _0x64c2b9;
            _0xacd671 = Math.max(32, 0.28 * this.size) * _0x17e08e;
            _0x425f14 = Math.max(14, 0.12 * this.size) * _0x17e08e;
            _0x32e705 = 1 - Math.abs(2 * _0x32e705 - 1);
            if (gameSettings.sGraphics < 3 && gameSettings.sCellAnimations) {
                _0x155535.t = _0x155535.s = _0x155535.r = true;
            }
            _0x155535.ty += _0xacd671 * (_0x32e705 - 0.5);
            _0x155535.tx += _0x425f14 * Math.sin(_0x64c2b9 * Math.PI * 2.5);
            _0x155535.sx *= 1 + 0.18 * _0x32e705 * _0x17e08e;
            _0x155535.sy *= 1 - 0.14 * _0x32e705 * _0x17e08e;
            _0x155535.rz += 0.04 * Math.sin(_0x64c2b9 * Math.PI * 12) * _0x17e08e;
        }
    }
    swayDance(_0x21c3b8) {
        var _0x52dac9;
        var _0xa35d34;
        var _0x1c209a = (currentFrameTime - _0x21c3b8.start) / playerEmotes[_0x21c3b8.id].duration;
        if (1 <= (_0x1c209a = _0x1c209a < 0 ? 0 : 1 < _0x1c209a ? 1 : _0x1c209a)) {
            _0x21c3b8.id = 0;
        } else {
            _0x52dac9 = this.getTransform();
            _0xa35d34 = _0x1c209a * Math.PI * 6;
            _0x21c3b8 = 1 - 0.6 * _0x1c209a;
            _0x1c209a = Math.max(12, 0.09 * this.size) * _0x21c3b8;
            if (gameSettings.sGraphics < 3 && gameSettings.sCellAnimations) {
                _0x52dac9.t = _0x52dac9.r = true;
            }
            _0x52dac9.tx += Math.sin(_0xa35d34) * _0x1c209a;
            _0x52dac9.rz += 0.06 * Math.sin(_0xa35d34) * _0x21c3b8;
        }
    }
    jellyDance(_0x16d735) {
        var _0x4823e8;
        var _0x1f2cd7 = (currentFrameTime - _0x16d735.start) / playerEmotes[_0x16d735.id].duration;
        if (1 <= (_0x1f2cd7 = _0x1f2cd7 < 0 ? 0 : 1 < _0x1f2cd7 ? 1 : _0x1f2cd7)) {
            _0x16d735.id = 0;
        } else {
            _0x4823e8 = this.getTransform();
            _0x16d735 = _0x1f2cd7 * Math.PI * 14;
            _0x1f2cd7 = 1 - 0.5 * _0x1f2cd7;
            _0x1f2cd7 = 0.11 * Math.sin(_0x16d735) * _0x1f2cd7;
            if (gameSettings.sGraphics < 3 && gameSettings.sCellAnimations) {
                _0x4823e8.s = true;
            }
            _0x4823e8.sx *= 1 + _0x1f2cd7;
            _0x4823e8.sy *= 1 - _0x1f2cd7;
        }
    }
    moonwalkDance(_0x23eae2) {
        var _0x58a48c;
        var _0x47385d;
        var _0x57dc6d = (currentFrameTime - _0x23eae2.start) / playerEmotes[_0x23eae2.id].duration;
        if (1 <= (_0x57dc6d = _0x57dc6d < 0 ? 0 : 1 < _0x57dc6d ? 1 : _0x57dc6d)) {
            _0x23eae2.id = 0;
        } else {
            _0x58a48c = this.getTransform();
            _0x47385d = _0x57dc6d * Math.PI * 11;
            _0x23eae2 = 1 - 0.35 * _0x57dc6d;
            _0x57dc6d = Math.max(42, 0.35 * this.size) * _0x23eae2;
            if (gameSettings.sGraphics < 3 && gameSettings.sCellAnimations) {
                _0x58a48c.t = _0x58a48c.r = true;
            }
            _0x58a48c.tx -= (0.45 + 0.55 * Math.abs(Math.sin(_0x47385d))) * _0x57dc6d;
            _0x58a48c.ty += Math.sin(2 * _0x47385d) * _0x57dc6d * 0.12;
            _0x58a48c.rz -= 0.045 * Math.sin(_0x47385d) * _0x23eae2;
        }
    }
    helixDance(_0x4308c3) {
        var _0xd1f60b;
        var _0x51a609 = (currentFrameTime - _0x4308c3.start) / playerEmotes[_0x4308c3.id].duration;
        if (1 <= (_0x51a609 = _0x51a609 < 0 ? 0 : 1 < _0x51a609 ? 1 : _0x51a609)) {
            _0x4308c3.id = 0;
        } else {
            _0xd1f60b = this.getTransform();
            _0x4308c3 = _0x51a609 * Math.PI * 10;
            _0x51a609 = 1 - 0.55 * _0x51a609;
            _0x51a609 = Math.max(14, 0.1 * this.size) * _0x51a609;
            if (gameSettings.sGraphics < 3 && gameSettings.sCellAnimations) {
                _0xd1f60b.t = true;
            }
            _0xd1f60b.tx += Math.cos(_0x4308c3) * _0x51a609;
            _0xd1f60b.ty += Math.sin(2 * _0x4308c3) * _0x51a609 * 0.5;
        }
    }
    hiccupDance(_0x23eb07) {
        var _0x2ce6f4;
        var _0x242553 = (currentFrameTime - _0x23eb07.start) / playerEmotes[_0x23eb07.id].duration;
        if (1 <= (_0x242553 = _0x242553 < 0 ? 0 : 1 < _0x242553 ? 1 : _0x242553)) {
            _0x23eb07.id = 0;
        } else {
            _0x2ce6f4 = this.getTransform();
            _0x23eb07 = 1 - 0.65 * _0x242553;
            _0x242553 = (_0x242553 = (_0x242553 = 4 * _0x242553) - Math.floor(_0x242553)) < 0.22 ? 1 - _0x242553 / 0.22 : 0;
            if (gameSettings.sGraphics < 3 && gameSettings.sCellAnimations) {
                _0x2ce6f4.t = _0x2ce6f4.s = true;
            }
            _0x2ce6f4.ty -= Math.max(18, 0.14 * this.size) * _0x242553 * _0x23eb07;
            _0x2ce6f4.sx *= 1 + 0.06 * _0x242553 * _0x23eb07;
            _0x2ce6f4.sy *= 1 - 0.05 * _0x242553 * _0x23eb07;
        }
    }
    expandDance(_0x5a7020) {
        var _0x1ff164;
        var _0xac2775 = (currentFrameTime - _0x5a7020.start) / playerEmotes[_0x5a7020.id].duration;
        if (1 <= (_0xac2775 = _0xac2775 < 0 ? 0 : 1 < _0xac2775 ? 1 : _0xac2775)) {
            _0x5a7020.id = 0;
        } else {
            _0x1ff164 = this.getTransform();
            _0x5a7020 = 1 - 0.4 * _0xac2775;
            _0x5a7020 = 1 + 0.45 * Math.sin(_0xac2775 * Math.PI) * _0x5a7020;
            if (gameSettings.sGraphics < 3 && gameSettings.sCellAnimations) {
                _0x1ff164.s = true;
            }
            _0x1ff164.sx *= _0x5a7020;
            _0x1ff164.sy *= _0x5a7020;
        }
    }
    collapseDance(_0x1b2e1e) {
        var _0x41038a = (currentFrameTime - _0x1b2e1e.start) / playerEmotes[_0x1b2e1e.id].duration;
        if (1 <= (_0x41038a = _0x41038a < 0 ? 0 : 1 < _0x41038a ? 1 : _0x41038a)) {
            _0x1b2e1e.id = 0;
        } else {
            _0x1b2e1e = this.getTransform();
            _0x41038a = 1 - 0.42 * Math.sin(_0x41038a * Math.PI);
            if (gameSettings.sGraphics < 3 && gameSettings.sCellAnimations) {
                _0x1b2e1e.s = true;
            }
            _0x1b2e1e.sx *= _0x41038a;
            _0x1b2e1e.sy *= _0x41038a;
        }
    }
    slinkyDance(_0x279d5f) {
        var _0x648be7;
        var _0x4580f0;
        var _0x56fb1b = (currentFrameTime - _0x279d5f.start) / playerEmotes[_0x279d5f.id].duration;
        if (1 <= (_0x56fb1b = _0x56fb1b < 0 ? 0 : 1 < _0x56fb1b ? 1 : _0x56fb1b)) {
            _0x279d5f.id = 0;
        } else {
            _0x648be7 = this.getTransform();
            _0x4580f0 = _0x56fb1b * Math.PI * 16;
            _0x279d5f = 1 - 0.5 * _0x56fb1b;
            _0x56fb1b = 0.18 * Math.sin(_0x4580f0) * _0x279d5f;
            if (gameSettings.sGraphics < 3 && gameSettings.sCellAnimations) {
                _0x648be7.s = _0x648be7.t = true;
            }
            _0x648be7.sx *= 1 + _0x56fb1b;
            _0x648be7.sy *= 1 - _0x56fb1b;
            _0x648be7.ty += Math.cos(_0x4580f0) * Math.max(10, 0.08 * this.size) * _0x279d5f;
        }
    }
    vortexDance(_0x315757) {
        var _0x10ca4e;
        var _0x24f8a7;
        var _0x31e93b = (currentFrameTime - _0x315757.start) / playerEmotes[_0x315757.id].duration;
        if (1 <= (_0x31e93b = _0x31e93b < 0 ? 0 : 1 < _0x31e93b ? 1 : _0x31e93b)) {
            _0x315757.id = 0;
        } else {
            _0x10ca4e = this.getTransform();
            _0x24f8a7 = _0x31e93b * Math.PI * 9;
            _0x315757 = 1 - 0.4 * _0x31e93b;
            _0x31e93b = Math.max(26, 0.18 * this.size) * (1 - _0x31e93b) * _0x315757;
            if (gameSettings.sGraphics < 3 && gameSettings.sCellAnimations) {
                _0x10ca4e.t = _0x10ca4e.r = _0x10ca4e.s = true;
            }
            _0x10ca4e.tx += Math.cos(_0x24f8a7) * _0x31e93b;
            _0x10ca4e.ty += Math.sin(1.35 * _0x24f8a7) * _0x31e93b * 0.8;
            _0x10ca4e.rz += (0.22 + 0.08 * Math.sin(0.5 * _0x24f8a7)) * _0x315757;
            _0x315757 = 0.1 * Math.sin(1.1 * _0x24f8a7) * _0x315757;
            _0x10ca4e.sx *= 1 + _0x315757;
            _0x10ca4e.sy *= 1 - 0.7 * _0x315757;
        }
    }
    glitchDance(_0x4521d1) {
        var _0x161765;
        var _0x30ef81;
        var _0x1eb5da = (currentFrameTime - _0x4521d1.start) / playerEmotes[_0x4521d1.id].duration;
        if (1 <= (_0x1eb5da = _0x1eb5da < 0 ? 0 : 1 < _0x1eb5da ? 1 : _0x1eb5da)) {
            _0x4521d1.id = 0;
        } else {
            _0x161765 = this.getTransform();
            _0x30ef81 = ~~(22 * _0x1eb5da);
            _0x4521d1 = 1 - 0.55 * _0x1eb5da;
            _0x1eb5da = Math.max(8, 0.09 * this.size) * _0x4521d1;
            if (gameSettings.sGraphics < 3 && gameSettings.sCellAnimations) {
                _0x161765.t = _0x161765.s = _0x161765.r = true;
            }
            if (_0x30ef81 % 4 == 0) {
                _0x161765.tx += _0x1eb5da;
                _0x161765.ty -= 0.45 * _0x1eb5da;
            } else if (_0x30ef81 % 4 == 1) {
                _0x161765.tx -= 1.15 * _0x1eb5da;
                _0x161765.ty += 0.3 * _0x1eb5da;
            } else if (_0x30ef81 % 4 == 2) {
                _0x161765.tx += 0.55 * _0x1eb5da;
                _0x161765.ty += 0.75 * _0x1eb5da;
            } else {
                _0x161765.tx -= 0.35 * _0x1eb5da;
                _0x161765.ty -= 0.6 * _0x1eb5da;
            }
            _0x161765.sx *= 1 + (_0x1eb5da = _0x30ef81 % 2 == 0 ? 0.09 : -0.09) * _0x4521d1;
            _0x161765.sy *= 1 - _0x1eb5da * _0x4521d1;
            _0x161765.rz += (_0x30ef81 % 2 == 0 ? 0.07 : -0.07) * _0x4521d1;
        }
    }
    drawHighlight(_0x1406e4, _0x5dc4ed, _0x5228a3, _0x418319) {
        var _0x52d848 = (currentFrameTime - _0x1406e4.start) / playerEmotes[_0x1406e4.id].duration;
        if (1 <= (_0x52d848 = _0x52d848 < 0 ? 0 : 1 < _0x52d848 ? 1 : _0x52d848) || this.destroyed) {
            _0x1406e4.id = 0;
        } else {
            ...
            _0x5dc4ed.lineJoin = this.spiked ? "miter" : "round";
            _0x5dc4ed.strokeStyle = gameSettings.sDark ? "#FFFFFF" : "#000000";
            _0x5dc4ed.stroke();
        }
    }
    drawCloakHighlight(_0xd35b2b, _0xe5b6db, _0x4f5fbc, _0xad7024) {
        var _0x2522fb = (currentFrameTime - _0xd35b2b.start) / playerEmotes[_0xd35b2b.id].duration;
        if (1 <= (_0x2522fb = _0x2522fb < 0 ? 0 : 1 < _0x2522fb ? 1 : _0x2522fb) || this.destroyed || this.ownCell) {
            _0xd35b2b.id = 0;
        } else {
            _0xe5b6db.globalAlpha = _0x2522fb < 0.5 ? 1 : 1 - (_0x2522fb - 0.5) / 0.5;
            _0xe5b6db.lineWidth = 30;
            _0xe5b6db.lineJoin = this.spiked ? "miter" : "round";
            _0xe5b6db.strokeStyle = gameSettings.sDark ? "#333333" : "#DDDDDD";
            _0xe5b6db.stroke();
        }
    }
    drawDragOver(_0x133747, _0x580a26, _0x4101ed, _0x3d84b9) {
        _0x133747.id = 0;
        _0x580a26.globalAlpha = 0.5;
        _0x580a26.fillStyle = "#FFFFFF";
        _0x580a26.fill();
    }
    drawFlash(_0x19b597, _0x2acef5, _0x5c3fed, _0x5720a0) {
        var _0x14aef6;
        var _0x210819;
        var _0x2f2e1c;
        var _0x3854da;
        var _0x48bf90;
        var _0x254cec = (currentFrameTime - _0x19b597.start) / playerEmotes[_0x19b597.id].duration;
        if (1 <= (_0x254cec = _0x254cec < 0 ? 0 : 1 < _0x254cec ? 1 : _0x254cec) || this.destroyed) {
            _0x19b597.id = 0;
    ...
    drawBlast(_0x263a12, _0x27b177, _0x16f54b, _0x3e0001) {
        var _0x228f94;
        var _0x279b6b = (currentFrameTime - _0x263a12.start) / playerEmotes[_0x263a12.id].duration;
        var _0x57f290 = {
            x: this.hx,
            y: this.hy
        };
    ...
    drawHit(_0x267d4a, _0xe60ca6, _0x9bb609, _0x5377cf) {
        var _0x26f399;
        var _0x57d5bc;
        var _0x3f06ab = (currentFrameTime - _0x267d4a.start) / playerEmotes[_0x267d4a.id].duration;
        if (1 <= (_0x3f06ab = _0x3f06ab < 0 ? 0 : 1 < _0x3f06ab ? 1 : _0x3f06ab)) {
            ...
            _0xe60ca6.globalAlpha = Math.clamp(100 / (this.strokeSize * _0x3e50d9), 0.5, 0.9) * _0x26f399 * _0x26f399 * (this.destroyed ? 0.5 : 1);
    ...
    drawSpeed(_0x42aaca, _0x559267, _0x3d73f2, _0x56a4f1) {
        var _0x330383 = (currentFrameTime - _0x42aaca.start) / playerEmotes[_0x42aaca.id].duration;
        if (1 <= (_0x330383 < 0 ? 0 : 1 < _0x330383 ? 1 : _0x330383) || this.destroyed) {
            _0x42aaca.id = 0;
        } else {
            if (!_0x42aaca.wt) {
                _0x42aaca.wt = [];
            ...
            } else if (1 < _0x42aaca.wt.length && (_0x24d1be = _0x42aaca.wt[0], _0x330383 = _0x42aaca.wt[1], _0x20e1c6 = _0x24d1be.rd + Math.min(_0x330383.time - _0x24d1be.time, 1000), currentFrameTime - _0x42aaca.wt[_0x42aaca.wt.length - 1].time > _0x20e1c6)) {
            ...
            if (1 < _0x42aaca.wt.length && gameSettings.sCellAnimations) {
                if (_0x585fc2 * _0x3e50d9 <= 16) {
                    ...
                    if ((_0x2c21f4 = speedlinesAnimations) && _0x2c21f4.complete && 0 != _0x2c21f4.width) {
    ...
    drawText(_0x2d721a, _0x4631dd, _0x3ddd98, _0x265307, _0x5b915d) {
        var _0x5cbb4d;
        var _0xe4a380;
        var _0x29e8fb;
        var _0x1be03d;
        ...
        if (_0x265307) {
            ...
            if (_0x265307 || this.clanPart) {
                if (_0x265307) {
                    var _0x450489 = " ";
                    for (var _0x55bb65 = 0; _0x55bb65 < this.stars; _0x55bb65++) {
                        _0x450489 += "★ ";
                    }
                    _0x5cbb4d = ~~(_0x1eaef0 / 1.5 + 0.5);
                    _0x1be03d = 6 < this.stars ? this.clanCache = _0x2182a7(this.clanCache, _0x450489, "#5cff00", "#000000", _0x5cbb4d) : this.clanCache = _0x2182a7(this.clanCache, _0x450489, "#FFD700", "#AA6C39", _0x5cbb4d);
                } else {
            ...
            if (this.namePart) {
                _0x29e8fb = (_0x1be03d = this.nameCache = _0x2182a7(this.nameCache, this.namePart, nicknameColors[this.colorIndexName], nicknameStrokeColors[this.colorIndexName], _0x5cbb4d = _0x1eaef0)).canvas;
                if ((_0xe4a380 = _0x5cbb4d / (_0x1be03d.size * _0x1be03d.appliedScale)) != _0x6261ce) {
                    _0x2d721a.scale(_0xe4a380 / _0x6261ce, _0xe4a380 / _0x6261ce);
                }
    ...
    drawMinimapCell(_0x449d3e) {
        ...
        if (this.anim) {
            for (var _0x52074e = 0; _0x52074e < this.anim.length; _0x52074e++) {
                switch ((_0x407dc4 = this.anim[_0x52074e]).id) {
                    case 3:   this.spin(_0x407dc4);          break;
                    case 6:   this.flip(_0x407dc4);          break;
                    case 7:   this.flipCoin(_0x407dc4);      break;
                    case 8:   this.shake(_0x407dc4);         break;
                    case 11:  this.jump(_0x407dc4);          break;
                    case 90:  this.orbit(_0x407dc4);         break;
                    case 91:  this.wobble(_0x407dc4);        break;
                    case 92:  this.pulseDance(_0x407dc4);    break;
                    case 93:  this.driftWave(_0x407dc4);     break;
                    case 94:  this.quakeDance(_0x407dc4);    break;
                    case 95:  this.swayDance(_0x407dc4);     break;
                    case 96:  this.jellyDance(_0x407dc4);    break;
                    case 97:  this.moonwalkDance(_0x407dc4); break;
                    case 98:  this.helixDance(_0x407dc4);    break;
                    case 99:  this.hiccupDance(_0x407dc4);   break;
                    case 102: this.slinkyDance(_0x407dc4);   break;
                    case 103: this.vortexDance(_0x407dc4);   break;
                    case 104: this.glitchDance(_0x407dc4);   break;
                }
                if (0 == _0x407dc4.id) {
                    this.anim.splice(_0x52074e, 1);
                    _0x52074e--;
                }
            }
            if (0 == this.anim.length) {
        ...
        if (!_0x393330) {
            _0x5be4cd.fillStyle = this.isGhosted ? "#AAAAAA" : gameSettings.sColors ? this.color : "#FFFFFF";
            _0x5be4cd.fill();
        }
        if (this.spiked && 4 < _0xffa50a || _0x393330) {
            _0x5be4cd.strokeStyle = this.isGhosted || !gameSettings.sColors ? "#666666" : this.colorDimmed;
            _0x5be4cd.stroke();
        }
        if (this.anim) {
            for (_0x52074e = 0; _0x52074e < this.anim.length; _0x52074e++) {
                switch ((_0x407dc4 = this.anim[_0x52074e]).id) {
                    case 9:
                        this.drawHit(_0x407dc4, _0x5be4cd, _0x57c74d, _0x556074);
                    ...
                    case 23:
                    case 17:
                        this.drawSprites(_0x407dc4, _0x5be4cd, _0x57c74d, _0x556074);
                        _0x39d073(_0x5be4cd, _0x449d3e);
                }
                if (0 == _0x407dc4.id) {
                    this.anim.splice(_0x52074e, 1);
            ...
            for (_0x52074e = 0; _0x52074e < this.anim.length; _0x52074e++) {
                switch ((_0x407dc4 = this.anim[_0x52074e]).id) {
                    case 1:
                        this.drawFlash(_0x407dc4, _0x5be4cd, _0x57c74d, _0x556074);
                        _0x39d073(_0x5be4cd, _0x449d3e);
                        break;
                    case 18:
                        this.drawBlast(_0x407dc4, _0x5be4cd, _0x57c74d, _0x556074);
                        _0x39d073(_0x5be4cd, _0x449d3e);
                }
                if (0 == _0x407dc4.id) {
                    this.anim.splice(_0x52074e, 1);
...
class PacketWriter {
    ...
    setInt16(value) {
        this.buffer.setInt16((this.position += 2) - 2, value, this.littleEndian);
        return this;
    }
    setUint16(value) {
        this.buffer.setUint16((this.position += 2) - 2, value, this.littleEndian);
        return this;
    }
    setInt32(value) {
        this.buffer.setInt32((this.position += 4) - 4, value, this.littleEndian);
        return this;
    }
    setUint32(value) {
        if (value % 1 != 0 && 88 == value.toString().slice(-2))
            value += 4;
        this.buffer.setUint32((this.position += 4) - 4, value, this.littleEndian);
        return this;
    }
    setFloat32(value) {
        this.buffer.setFloat32((this.position += 4) - 4, value, this.littleEndian);
        return this;
    }
    setFloat64(value) {
        this.buffer.setFloat64((this.position += 8) - 8, value, this.littleEndian);
        return this;
    }
    send(force) {
        if (isWebSocketAccepted || force)
            ws.send(this.buffer);
    }
}
class PacketReader {
    constructor(message, position) {
        this.buffer = new DataView(message.data);
...
function wsOnMessage(_0x2ba470) {
    var _0x427639;
    var pkt = new PacketReader(_0x2ba470, 0);
    if (240 === pkt.buffer.getUint8(0)) {
        pkt.position += 5;
    }
    switch (pkt.getUint8()) {
        case 10:
            currentFrameTime = Date.now();
            _0x27fdb0 = currentFrameTime;
            _0x2c6f91 = !(_0x29246b = false);
            var _0x50a1de = pkt.getUint16();
            var _0x409f62 = [];
            for (let _0x35b8f9 = 0; _0x35b8f9 < _0x50a1de; _0x35b8f9++) {
                var _0x483b2e = pkt.getUint8();
                var _0x45e923 = 2 & _0x483b2e ? pkt.getUint8() : 0;
                var _0x33f876 = 32 & _0x483b2e ? pkt.getUint8() : 0;
                var _0x5a0928 = pkt.getUint32();
                var _0x3d9855 = 1 & _0x483b2e ? pkt.getUint32() : _0x5a0928;
                var _0x2b26c8 = pkt.getString();
                var _0x3db74e = pkt.getUint16();
                var _0x3fb60f = pkt.getUint8();
                let _0x257e81 = pkt.getWearables();
                if (0 < _0x27324d.length && mainPlayerCells && 0 < mainPlayerCells.length && mainPlayerCells[0].pid === _0x5a0928) {
                    _0x257e81 = _0x27324d;
                }
                _0x409f62.push({
                    pid: _0x5a0928,
                    ...
                    s: _0x3db74e,
                    w: _0x257e81,
                    colorIndexName: _0x45e923,
                    isMinion: !!(1 & _0x483b2e),
                    isGhosted: !!(4 & _0x483b2e),
                    isCloaked: !!(8 & _0x483b2e),
                    coronaSpikes: !!(16 & _0x483b2e),
                    stars: _0x33f876,
                    touchUser: _0x3fb60f
                });
            }
            for (;;) {
                var _0x269ac7 = pkt.getUint32();
                if (0 === _0x269ac7) {
                    break;
                }
                var _0x29879a = pkt.getInt32();
                var _0x1da5bc = pkt.getInt32();
                var _0x2c474f = pkt.getUint16();
                var _0x447e2a = pkt.getUint8();
                ...
                let _0x5eed3f;
                let _0x3a2844;
                if (_0x13100f && (_0x1d95fc = !!(2 & _0x447e2a), _0x534ff6 = pkt.getUint8(), _0x1bf5f0 = 8 & _0x447e2a ? pkt.getUint8() : 0, [_0x24ed2e, _0x5eed3f] = pkt.getColorTags(), 0 === _0x534ff6)) {
                    _0x3a2844 = _0x409f62[pkt.getUint16()];
                }
                let cell = !_0x13100f || Object.prototype.hasOwnProperty.call(allCells, _0x269ac7) ? allCells[_0x269ac7] : null;
                if (cell) {
                    /* TODO: sort
                    const ii = allNonFoodCells.indexOf(cell);
                    let i = ii;
                    if (_0x2c474f < cell.size) {
                        while (i > 0 && allFoodCells[i - 1]?.size > _0x2c474f) i--;
                    } else {
                        const n = allNonFoodCells.length - 1;
                        while (i < n && allFoodCells[i + 1]?.size < _0x2c474f) i++;
                    }
                    if (i !== ii) {
                        allNonFoodCells.splice(ii, 1);
                        allNonFoodCells.splice(i, 0, cell);
                    }*/
                    ...
                    cell = new Cell(_0x269ac7, _0x29879a, _0x1da5bc, _0x2c474f);
                    ...
                    if (_0x13100f) {
                        if (1 === _0x534ff6) {
                            ...
                            allNonFoodCells.push(cell);
                            /*const n = allNonFoodCells.length;
                            let i = 0;
                            while (i < n && allFoodCells[i]?.size < _0x2c474f) i++;
                            allNonFoodCells.splice(i - 1, 0, cell);*/

                            if (_0x49dbad[_0x269ac7]) {
                                for (let i = 0; i < _0x49dbad[_0x269ac7].length; i++) {
                                    cell.setAnimation(_0x49dbad[_0x269ac7][i]);
                                }
                            }
                            if (0 === _0x534ff6) {
                                cell.pid = _0x3a2844.pid;
                                cell.oid = _0x3a2844.oid;
                                var _0x3ac3de = _0x3a2844.isMinion ? minionsByOid : playersByOid;
                                let _0x2f9bf8 = _0x3ac3de[_0x3a2844.oid];
                                (_0x2f9bf8 = _0x2f9bf8 || (_0x3ac3de[_0x3a2844.oid] = [])).push(cell);
                                if (_0x4df025[cell.pid]) {
                                    for (let i = 0; i < _0x4df025[cell.pid].length; i++) {
                                        cell.setAnimation(_0x4df025[cell.pid][i]);
                                    }
                                }
                                if (_0x3a2844.isMinion && _0x59222b[cell.oid]) {
                                    for (let i = 0; i < _0x59222b[cell.oid].length; i++) {
                                        cell.setAnimation(_0x59222b[cell.oid][i]);
                                    }
                                }
                            } else if (13 === _0x534ff6) {
                                cell.setAnimation({
                                    "id": 7,
                                    "start": playerEmotes[7].time(-~~(2000 * Math.random())),
                                    "received": ++_0x57f5d0
                                });
                            } else if (4 === _0x534ff6) {
                                cell.strokeSize = 0.83 * _0x2c474f;
                            }
                            if (!(!gameSettings.sPolygonShapes && !gameSettings.sLineShapes || 0 !== _0x534ff6 && 3 !== _0x534ff6)) {
                                cell.shape = gameSettings.sLineShapes ? 2 : foodCellRandomShapes[_0x269ac7 % 100];
                                cell.rotation = (2 * Math.random() - 1) * Math.PI;
                            }
                    ...
                    cell.createTime = currentFrameTime;
                }
                cell.hx = _0x29879a;
                cell.hy = _0x1da5bc;
                ...
                if (_0x13100f && (cell.color = _0x24ed2e, cell.colorDimmed = cell.smallFood ? _0x24ed2e : _0x5eed3f, cell.spiked = _0x1d95fc ? 2 === _0x534ff6 || 9 === _0x534ff6 || 22 === _0x534ff6 ? 2 : 1 : 0, 1 !== (cell.type = _0x534ff6))) {
                    ...
                    if (0 === _0x534ff6) {
                        if (
                            !cell.ownCell &&
                            -1 !== mainPlayerCellsIds.indexOf(_0x269ac7) &&
                            -1 === mainPlayerCells.indexOf(cell)
                        ) {
                            mainPlayerCells.push(cell);
                            cell.ownCell = true;
                            if (1 === mainPlayerCells.length) {
                                viewX = (0.1 * viewX + cell.x) / 1.1;
                                viewY = (0.1 * viewY + cell.y) / 1.1;
                                _0x248dac = true;
                                sendSignal(13);
                                _0x10236d()
                            }
                        }
                        (_0x3a2844.n || cell.name) && cell.parseName(_0x3a2844.n);
                        cell.skinId = _0x3a2844.s;
                        cell.colorIndexName = _0x3a2844.colorIndexName;
                        cell.isMinion = _0x3a2844.isMinion;
                        cell.isGhosted = _0x3a2844.isGhosted;
                        // cell.isCloaked = _0x3a2844.isCloaked;
                        cell.coronaSpikes = _0x3a2844.coronaSpikes;
                        cell.stars = _0x3a2844.stars;
                        cell.wears = _0x3a2844.w;
                        cell.touchUser = _0x3a2844.touchUser;
                        if (cell.wears)
                            for (let i = 0; i < cell.wears.length; i++)
                                cell.reloadWear(cell.wears[i]);
                    }
                    cell.reloadImage();
                    cell.orientation = 16 & _0x447e2a ? 1 : 0;
                }
                if (0 === cell.type) {
                    cell.singleCellPlayer = !!(4 & _0x447e2a);
                    cell.sameParty = !!(64 & _0x447e2a);
                }
            }
            break;
        case 11:
            ...
            for (let _0x3c5438 = 0; _0x3c5438 < _0x50a1de; _0x3c5438++) {
                var _0x37f254 = pkt.getUint32();
                var _0x5c6537 = allCells[_0x37f254] || _0x37d117[_0x37f254];
                var _0x2242da = allCells[pkt.getUint32()];
                if (_0x2242da && (_0x5c6537 ? (_0x2242da.destroy(true), _0x2242da.ox = _0x2242da.x, _0x2242da.oy = _0x2242da.y, _0x2242da.oSize = _0x2242da.size, _0x5c6537 !== _0x2242da && (_0x2242da.hx = _0x5c6537.x, _0x2242da.hy = _0x5c6537.y), _0x2242da.nSize = _0x2242da.size, _0x2242da.updateTime = currentFrameTime, _0x5c6537.isCloaked && !_0x5c6537.ownCell && 0 === _0x2242da.type && _0x2242da.pid !== _0x5c6537.pid && (_0x5c6537.clearAnimation(16), _0x5c6537.setAnimation({
                        "id": 16,
                        "start": playerEmotes[16].time(),
                        "received": ++_0x57f5d0
                    }))) : _0x2242da.destroy(false), 1 !== _0x2242da.type)) {
                    _0x37d117[_0x37f254] = _0x2242da;
                }
            }
            break;
        case 12:
            _0x50a1de = pkt.getUint32();
            for (let _0x5b952f = 0; _0x5b952f < _0x50a1de; _0x5b952f++) {
                var _0x51781b = allCells[pkt.getUint32()];
                if (null != _0x51781b) {
                    _0x51781b.destroy(false);
                }
            }
            if (_0x29246b && 0 === mainPlayerCells.length) {
                onPlayerDeath();
            }
            break;
        case 17:
            var _0xb790f3 = pkt.getFloat32();
            var _0x571f96 = pkt.getFloat32();
            _0x29c97b = pkt.getFloat32();
        ...
        case 20:
            ...
            break;
        case 32:
            mainPlayerCellsIds.push(pkt.getUint32());
            isSpectating = false;
            if (1 === mainPlayerCellsIds.length) {
                _0x203625();
            }
            break;
        case 33:
            ...
            if (0 != _0xb790f3) {
                ...
                for (var i = 0; i < _0x435e7a; i++) {
                    _0x5c8d2e.push(pkt.getUint32());
                }
            }
            _0x435e7a = pkt.getUint8();
            for (i = 0; i < _0x435e7a; i++) {
                _0x6cf8bb.push(pkt.getUint8());
            }
            ...
            if (0 == _0x2a3116) {
                for (var _0x1d1cb6 = 0; _0x1d1cb6 < _0x5c8d2e.length; _0x1d1cb6++) {
                    ...
                    var _0x5013c6 = allCells[_0x426b1b];
                    for (var _0x5211eb = 0; _0x5211eb < _0x6cf8bb.length; _0x5211eb++) {
                        if (0 == (_0x3d8b30 = _0x6cf8bb[_0x5211eb]) || _0x5daecd) {
                            if (_0x5013c6) {
                                _0x5013c6.clearAnimation(_0x3d8b30);
                            }
                            _0x468acc(_0x2a3116, _0x426b1b, _0x3d8b30);
                        } else {
                            _0x5bd0ee = playerEmotes[_0x3d8b30];
                            _0x57f54c = {
                                "id": _0x3d8b30,
                                "start": _0x5bd0ee.time(-_0x346550),
                                "received": _0x57f5d0
                            };
                            if (_0x5bd0ee.time() < _0x57f54c.start + _0x5bd0ee.duration) {
                                if (_0x5013c6) {
                                    _0x5013c6.setAnimation(_0x57f54c);
                                }
                ...
                for (_0x1d1cb6 = 0; _0x1d1cb6 < allNonFoodCells.length; _0x1d1cb6++) {
                    if (0 == (_0x5013c6 = allNonFoodCells[_0x1d1cb6]).type && (1 == _0x2a3116 && _0x5013c6.pid == _0x399168 || 2 == _0x2a3116 && _0x5013c6.isMinion && _0x5013c6.oid == _0x399168)) {
        ...
        case 50:
            _0x634c41 = [];
            var _0x182a40 = pkt.getUint16();
            for (var i = 0; i < _0x182a40; ++i) {
                _0x634c41.push(pkt.getFloat32());
            }
            _0x3c3250 = true;
            break;
        case 53:
            var _0x435e7a = pkt.getUint16();
            var _0xb790f3 = pkt.getUint8();
            spinWheelPlayAdvert = 1 == _0x435e7a && _0xb790f3;
            $("#remainingSpins").text(_0x435e7a);
            break;
        case 54:
            var _0x46fd3a = pkt.getUint8();
        ...
        case 56:
            ...
            break;
        case 64:
            _0x5c1aa9 = mapInfos.left = mapInfos.oLeft = mapInfos.nLeft = pkt.getUint32();
            _0x4ba286 = mapInfos.top = mapInfos.oTop = mapInfos.nTop = pkt.getUint32();
            _0x28f6af = mapInfos.right = mapInfos.oRight = mapInfos.nRight = pkt.getUint32();
            _0x500945 = mapInfos.bottom = mapInfos.oBottom = mapInfos.nBottom = pkt.getUint32();
            mapInfos.draw = false;
            _0x53b8b0 = _0x46ac7b = _0x40e81b = (_0x5c1aa9 + _0x28f6af) / 2;
            _0x464afc = _0x2c7938 = _0x6c7bce = (_0x4ba286 + _0x500945) / 2;
            _0x29c97b = 1;
            if (!(mapCenterSet || (mapCenterSet = true, viewX = _0x53b8b0, viewY = _0x464afc, gameSettings.sFixedZoom))) {
            ...
            if (_0x435e7a === _0x571f96) {
                ...
                if (currentServerId === 48 && secretWorldPassword)
                    new PacketWriter(3 + 2 * secretWorldPassword.length)
                        .setUint8(134)
                        .setString(secretWorldPassword)
                        .send(true);
            } else {
                _0x13d7e0();
                wsOnClose();
            ...
            break;
        case 65:
            _0x5c1aa9 = mapInfos.left = mapInfos.oLeft = mapInfos.nLeft = pkt.getFloat64();
            _0x4ba286 = mapInfos.top = mapInfos.oTop = mapInfos.nTop = pkt.getFloat64();
            _0x28f6af = mapInfos.right = mapInfos.oRight = mapInfos.nRight = pkt.getFloat64();
            _0x500945 = mapInfos.bottom = mapInfos.oBottom = mapInfos.nBottom = pkt.getFloat64();
            mapInfos.draw = false;
            _0x27fdb0 = Date.now();
            _0x2c6f91 = true;
            break;
        case 66:
            var _0x3205e2 = pkt.getFloat64();
            var _0xb790f3 = pkt.getFloat64();
            var _0x46fd3a = pkt.getFloat64();
            var _0x571f96 = pkt.getFloat64();
            var _0x435e7a = Date.now();
            if (!mapInfos.draw || 3600 < _0x435e7a - mapInfos.updateTime) {
                mapInfos.left = mapInfos.oLeft = mapInfos.nLeft = _0x3205e2;
                mapInfos.top = mapInfos.oTop = mapInfos.nTop = _0xb790f3;
                mapInfos.right = mapInfos.oRight = mapInfos.nRight = _0x46fd3a;
                mapInfos.bottom = mapInfos.oBottom = mapInfos.nBottom = _0x571f96;
                mapInfos.ga = 0;
                mapInfos.createTime = _0x435e7a;
            } else {
                _0x4f401c(_0x435e7a);
                mapInfos.oLeft = mapInfos.left;
                mapInfos.oTop = mapInfos.top;
                mapInfos.oRight = mapInfos.right;
                mapInfos.oBottom = mapInfos.bottom;
                mapInfos.nLeft = _0x3205e2;
                mapInfos.nTop = _0xb790f3;
                mapInfos.nRight = _0x46fd3a;
                mapInfos.nBottom = _0x571f96;
            }
            mapInfos.updateTime = _0x435e7a;
            mapInfos.draw = true;
            _0x2c6f91 = true;
            break;
        case 75:
            ...
            break;
        case 76:
            _0x568853 = pkt.getFloat32();
            _0x593148();
            break;
        case 80:
            _0x24af02 = pkt.getUint16();
            _0x4a4cf7 = pkt.getUint32();
            var _0x571f96 = !!(1 & (_0x3626db = pkt.getUint8()));
        ...
        case 89:
            ...
            if ('' == _0x5e72c3) {
                ...
                curserMessage(_0x5e72c3, false, _0x280d4d, _0x1a0051, _0xf64257);
            }
            break;
        case 91:
            var _0x5e72c3 = pkt.getString();
            ...
            break;
        case 92:
            _0x1e9905 = pkt.getString();
            challengeImageId = pkt.getUint8();
            _0x170049 = pkt.getUint8();
            pkt.getUint8();
            pkt.getUint8();
            _0x352c3f = pkt.getUint32();
            ...
            break;
        case 93:
            _0x3b0d92 = pkt.getUint8();
            if (12 == _0x3b0d92) {
                animateExpReward();
                playSounds("sounds/challenge_complete.mp3", 1);
            } else if (9 == _0x3b0d92) {
                _0x184d89 = pkt.getUint16();
                _0x5180de = pkt.getUint16();
                _0x5381b4 = pkt.getUint16();
                _0x3a4da8 = pkt.getUint16();
                _0x3988b2 = pkt.getUint16();
                _0x1124f6 = pkt.getUint16();
                _0x3884cc = pkt.getUint16();
                _0x24a818 = pkt.getUint16();
                _0x38a139 = pkt.getUint16();
                _0x2712a9 = pkt.getUint16();
        ...
        case 95:
            ...
            if (1 == _0x2f2313) {
                ...
                if (_0x363e25) {
                    ...
                    if (_0xea465f.toLowerCase() != _0x3ebb17.toLowerCase()) {
                        ...
                        _0x53e3b2 = setTimeout(function() {
                            if (_0x363e25 && isLoggedIn && 5000 < Date.now() - _0x21e585) {
                                _0xbcbc52();
                            }
                        }, 5000);
                    }
                ...
                if (!isLoggedIn && Date.now() < _0x186b83) {
                    _0x582d99 = setTimeout(function() {
                        autoLogin(_0x5b6b18, _0x170269);
                    }, 500);
                } else {
        ...
        case 96:
            ...
            var _0x2b96e1 = pkt.getUint16();
            var _0x2e4161 = pkt.getUint32();
            _0x107e7f = pkt.getUint32();
            var _0x280d4d = pkt.getUint32();
            var _0x5e72c3 = pkt.getString();
            ignoreTrustedEvent = true;
            _0xea465f = _0x5e72c3;
            _0x11c620();
        ...
        case 97:
            ...
            break;
        case 98:
            _0x2b96e1 = pkt.getUint16();
            _0x26039d = pkt.getUint32();
            if (isLoggedIn) {
                _0x2bb62d(_0x2b96e1, _0x26039d);
            }
            break;
        case 99:
            var _0x3988b2 = pkt.getUint8();
            ...
            var [_0x2cc170] = pkt.getColorTags();
            var _0x4c6837 = pkt.getString();
            var _0x3626db = 2 & _0x3988b2 ? pkt.getString() : '';
            var _0x469523 = null;
            var _0x1711bf = !!(8 & _0x3988b2);
            chatMessages.push({
                "selectable": _0x3884cc,
                "sid": currentServerId,
                "pid": _0x24a818,
                "uid": _0x2712a9,
                "iid": _0x3b0d92,
                ...
                "receiver": _0x3626db,
                "color": _0x2cc170,
                "message": pkt.getString(),
                "category": 1 & _0x3988b2 ? 1 : 2 & _0x3988b2 ? 2 : 0,
                "goldMember": !!(16 & _0x3988b2),
                "moderator": 32 & _0x3988b2 ? 1 : 64 & _0x3988b2 ? 2 : 0,
                "donator": 1 & _0x1124f6 ? 1 : 2 & _0x1124f6 ? 2 : 4 & _0x1124f6 ? 3 : 8 & _0x1124f6 ? 4 : 16 & _0x1124f6 ? 5 : 32 & _0x1124f6 ? 6 : 0,
                "yt": !!(64 & _0x1124f6),
                "touchUser": !!(128 & _0x1124f6),
                "shout": _0x1711bf && _0x238c81,
                "time": Date.now(),
                "cache": null
            });
            if (1 & _0x3988b2) {
        ...
        case 102:
            if (2 == pkt.getUint8()) {
                _0x20546f = pkt.getUint16();
                var _0x3c2960 = pkt.getString();
                var _0x15ca97 = pkt.getString();
                var _0x55cf4d = pkt.getString();
                var _0x2d1f83 = pkt.getString();
                var _0x17a702 = pkt.getString();
                switch (pkt.getString()) {
                    case "A":
                ...
                _0x20546f = pkt.getUint16();
                _0x3c2960 = pkt.getString();
                _0x15ca97 = pkt.getString();
                _0x55cf4d = pkt.getString();
                _0x2d1f83 = pkt.getString();
                _0x17a702 = pkt.getString();
                $("#quiz-loaded").hide();
                $("#quiz-content").show();
            ...
            if (0 < (_0x435e7a = pkt.getUint16())) {
                ...
                for (var i = 0; i < _0x435e7a; ++i) {
                    ...
                    newGameservers.push({
                        "id": _0x395b2d,
                        "name": pkt.getString(),
                        "description": pkt.getString(),
                        "address": pkt.getString(),
                        "location": pkt.getUint8(),
                ...
                if (!_0x8e4a8e) {
                    if (!(objectChanged = newGameservers.length != gameservers.length)) {
                        for (i = 0;  i < gameservers.length; ++i) {
                            ...
                            if (
                                _0x1909f7.id != _0x4619e3.id
                                || _0x1909f7.name != _0x4619e3.name
                                || _0x1909f7.description != _0x4619e3.description
                                || _0x1909f7.address != _0x4619e3.address
                                || _0x1909f7.location != _0x4619e3.location
                                || _0x1909f7.gamemode != _0x4619e3.gamemode
                                || _0x1909f7.maxPlayers != _0x4619e3.maxPlayers
                            ) {
                                objectChanged = true;
                                break;
                            }
        ...
        case 111:
            ...
            for (i = 0; i < _0x435e7a; ++i) {
                var _0x395b2d = pkt.getUint16();
                var _0x4847d6 = pkt.getUint16();
                var _0x3ac0d3 = pkt.getUint16();
                $("#serverPlayers" + _0x395b2d).text(_0x4847d6 + "/" + _0x3ac0d3);
            }
            break;
        case 112:
            _0x26baf3 = pkt.getUint8();
            ag219_2 = 2 == _0x26baf3 ? (_0x191e79 = pkt.getString(), localStorage.setItem("crcx2", _0x191e79), _0x191e79) : pkt.getString();
            break;
        case 114:
            if (0 < (_0x435e7a = pkt.getUint16())) {
                _0x51aa44 = [];
                for (i = 0; i < _0x435e7a; ++i) {
                    ...
                    if (1 == _0x3af9db) {
                        ...
                        _0x51aa44[_0x51aa44.length - 1].vipLevelRequired = pkt.getUint8();
                    } else if (2 == _0x3af9db) {
                        _0x51aa44[_0x51aa44.length - 1].price = pkt.getUint32();
                    }
                }
                _0x568cd2();
                _0x1518ea = false;
        ...
        case 125:
            ...
            break;
        case 126:
            _0x3c2960 = (_0x26039d = pkt).getUint8();
            ...
            chatMessages.push({
                ...
                "moderator": 32 & _0x3c2960 ? 1 : 64 & _0x3c2960 ? 2 : 0,
                "donator": 1 & _0x15ca97 ? 1 : 2 & _0x15ca97 ? 2 : 4 & _0x15ca97 ? 3 : 8 & _0x15ca97 ? 4 : 16 & _0x15ca97 ? 5 : 32 & _0x15ca97 ? 6 : 0,
                "yt": !!(64 & _0x15ca97),
                "touchUser": !!(128 & _0x15ca97),
                "shout": false,
                "time": Date.now(),
                "cache": null,
                "sender": _0x17a702,
        ...
        case 132:
            ...
            break;
        case 133: {
            const address = pkt.getString();
            secretWorldPassword = pkt.getString() || '';
            // 4+1+1+1 useless bytes
            if (address) connectserver(address, "Secret World");
            break;
        }
        case 209:
            _0x311374 = pkt.getUint16();
            _0x2f2313 = pkt.getUint16();
            $("#thumbUpCount").text(_0x311374);
            $("#thumbDownCount").text(_0x2f2313);
            break;
        case 244:
            if (1 === pkt.buffer.byteLength) {
                isWebSocketAccepted = true;
                if (0 < ag219_2.length) {
                ...
                if (false) sendSignal(182); // isMobile
            }
    }
}

function getModeFromId(id) {
    return gameServerModes[id] || '';
}
...
function _0x40eece(_0x16a881) {
    if (_0x16a881 != getModeFromId(17) && $(".agma-logo").hasClass("agma_corona-simulator")) {
        $(".agma-logo").removeClass("agma_corona-simulator");
    }
    if (_0x16a881 == getModeFromId(15)) {
        $(".agma-logo").attr("src", "img/agma_royale_lo.png");
    } else if (_0x16a881 == getModeFromId(17)) {
...
function _0x2e104c() {
    if (_0x363e25) {
        ...
        _0x363e25 = true;
        if (!_0x3f3ed9) {
            if (5000 < Date.now() - _0x21e585 || _0x5b3d82 != isLoggedIn || _0xea465f.toLowerCase() != _0x3ebb17.toLowerCase()) {
                _0xbcbc52();
            }
            _0x3f3ed9 = setInterval(_0xbcbc52, 28000);
        }
...
function _0x4d3094() {
    ...
    var _0x5990ff;
    var _0x4ebe0d;
    var _0x5dd920 = ~~(Math.max(200 * Math.min(1.6 * clientHeight, clientWidth, 1400) / 1400, 90) + 0.5) / 200;
    ...
    _0x4ebe0d = _0x363e25 ? (_0x22af33 = _0x4abb41.outerHeight() * (_0x4386c1 ? 0.7 : 1), _0x39f84e = _0x4abb41.outerWidth() * (_0x4386c1 ? 0.7 : 1), _0x5990ff = (_0x4ebe0d = _0x4abb41.offset()).top, _0x4ebe0d = _0x4ebe0d.left, _0x5990ff = Math.clamp(_0x5990ff, 0, clientHeight - _0x22af33), Math.clamp(clientWidth - _0x4ebe0d - _0x39f84e, 0, clientWidth - _0x39f84e)) : (_0x5990ff = 12 + (_0x22af33 = _0x4386c1 ? 28 : 40), _0x4386c1 ? 0 : _0x5dd920 + _0x22af33);
    _0x4abb41.css({
        "right": _0x4ebe0d + "px",
        "top": _0x5990ff + "px"
    });
...
function _0x569497(_0x429c2c) {
    ...
    function _0xaea786(_0x4fa54d) {
        if (_0x363e25) {
            _0x5b76e2.css({
                "right": clientWidth - (_0x4fa54d.pageX - _0x46fcff) + "px",
    ...
    if (!(0 != _0x429c2c.button || _0x5b76e2.hasClass("actives"))) {
        ...
        _0x46fcff = _0x429c2c.pageX - _0x4bcacc.left - _0x5b76e2.width() * (_0x4386c1 ? 0.7 : 1);
...
function _0x20ddff(_0x22b948) {
    ...
    function _0x135ea0(_0x1e003d) {
        if (_0x363e25) {
            _0x2de48c = Math.clamp(_0x3caddb + (_0x1e003d.clientX - _0x330bf8) / (_0x4386c1 ? 0.7 : 1), 200, clientWidth);
            _0x517404 = Math.clamp(_0x36ed80 + (_0x1e003d.clientY - _0x25ffd4) / (_0x4386c1 ? 0.7 : 1), 240, clientHeight);
            _0x48b630.css({
                "width": _0x2de48c + "px",
                "height": _0x517404 + "px",
                "right": _0x1c3998 - (_0x2de48c - _0x3caddb) * (_0x4386c1 ? 0.7 : 1) + "px"
            });
        } else {
            _0x5e3774();
        }
...
function _0x4d8d48() {
    _0x34cf3b = _0x34cf3b ? ($("#settingsDialog").stop(true, false).css({ overflow: '' }).removeClass("shown").delay(200).hide(0), false) : ($("#settingsDialog").stop(true, false).show(0).addClass("shown").delay(300).queue(function(_0x261f27) {
        $(this).css({ overflow: '' });
        _0x261f27();
    }), true);
}
...
const regions = [
    { location: 0, code: 'EU', name: 'Europe' },
    { location: 1, code: 'NA', name: 'North America' },
...
function updateServersPanel(currentServer) {
        ...
        <section>
          ...
          <div class="server-tabmenu">
            <table class="server-table">
              ...
              <tbody>${gameservers.filter(server => server.location === location).map(server => `
                <tr id="serverRow${server.id}" class="" title="${server.description}" onclick="$('table.server-table tr').removeClass('active'); $(this).addClass('active'); setserver('${server.address}', '${server.name}');">
                  <td>${server.name}</td>
                  <td id="serverPlayers${server.id}">0/${server.maxPlayers}</td>
    ...
    if (currentServer) {
        $("table.server-table tr").removeClass("active");
        $("#serverRow" + currentServer.id).addClass("active");
    }
}
...
function _0x2bb62d(level, xp) {
    ...
    if (!(0 == level && 0 == xp)) {
        _0x1d75bb = level <= 0 ? 0 : Math.min(100 * xp / (1000 * level), 100);
        $(".progress-bar").css("width", _0x1d75bb.toString() + "%");
        $(".exp-bar").text(~~_0x1d75bb + "%");
        if (0 != level) {
            (_0x1d75bb = $("#level,#level2")).text(level);
            if (50 <= level) {
        ...
        accountRessources.level = level;
        accountRessources.exp = xp;
        window.refreshDanceMenuLocks();
    }
}
...
function _0x14cfd2(i, _0x1096c2, _0x46db45) {
    ...
    if (!_0x28448d) {
        _0x28448d = [_0x49dbad, _0x4df025, _0x59222b][i][_0x1096c2] = [];
        [_0x463a1e, _0x2032b6, _0x5bdc9e][i].push(_0x1096c2);
    }
    ...
    if (_0x32de60) {
        if (0 == _0x2ee8ab) {
            ...
            for (var _0x14ce5d = 0; _0x14ce5d < _0x32de60.length; _0x14ce5d++) {
                if (_0x32de60[_0x14ce5d].id == _0x2ee8ab) {
...
function sendString(id, text) {
    if (isReady()) {
        new PacketWriter(1 + 2 * text.length).setUint8(id).setString(text).send();
    }
}
...
function _0x483c7e(_0x4bd171) {
    ...
    if (/^(?:gachaCommand|\/gacha|\/gacha1|\/gacha2|\/gacha3|\/ping|\/fps)/.test(_0x48b4f1)) {
        if (/^(?:\/gacha3)/.test(_0x48b4f1)) {
            curserMessage("Secret command... enjoy the skins and wearables!", false, true, 1, 5);
            tskngc(_0x1b76cc);
            var _0xdc8e74 = 0;
            ...
            if (_0x3e08c0 || mainPlayerCells.length < 1) {
                curserMessage("You must spawned in game to issue this command", false, true, 0, 5);
            } else {
                setNick(currentNickname);
            }
        } else {
...
var _0x3a188d = function(_0x3d9c37) {
    ...
    if (!_0xe01c9e && 1 < mainPlayerCells.length && _0xe31776 <= 20) {
        curserMessage("Your FPS seems to be low, you can lower your graphics quality to reduce lag. You can change this in the Game Settings.", !(_0xe01c9e = true), true, 0, 10);
    }
    _0x18fde3 = _0x3d9c37 - _0x53278f % FRAMERATE;
...
function _0x41e1d9() {
    ...
    _0xd28f67 = gameSettings.sFixedZoom ? gameSettings.fixedZoomScale : (_0x29c97b = -1 != (_0xeb2666 = (() => {
        ...
        var _0x3cc956 = 0;
        for (var _0x3832fb = 0; _0x3832fb < mainPlayerCells.length; _0x3832fb++) {
            _0x3cc956 += mainPlayerCells[_0x3832fb].size;
        }
        return _0x3cc956;
...
function _0x51c554() {
    ...
    _0x1fc141.width = Math.max(~~(clientWidth * _0x28ad4b + 0.5), 1);
    _0x1fc141.height = Math.max(~~(clientHeight * _0x28ad4b + 0.5), 1);
    _0x1fc141.style.width = clientWidth + "px";
    _0x1fc141.style.height = clientHeight + "px";
    _0xb14342.scale(_0x28ad4b, _0x28ad4b);
    var _0x5c60a6 = $("#advertDialogs");
    var _0x19a05e = Math.min(clientWidth / 970, clientHeight / 800);
    if (_0x19a05e < 1) {
    ...
    if ((_0x19a05e = Math.max(clientHeight / 920, 0.7)) < 1) {
    ...
    if ((_0x19a05e = Math.max(clientWidth / 1000, 0.4)) < 1) {
        _0x5c60a6.css("transform", "scale(" + _0x19a05e + ")");
    } else {
        _0x5c60a6.css("transform", "none");
    }
    if (!(_0x4386c1 = clientWidth <= 909)) {
        $("#loginPanel").css("display", '');
        $("#serverPanel").css("display", '');
        $("#mainPanel").css("display", '');
    }
    var _0x5c60a6 = ~~(Math.max(200 * Math.min(1.6 * clientHeight, clientWidth, 1400) / 1400, 90) + 0.5) / 200;
    $("#brGameContainer").css("transform", "scale(" + _0x5c60a6 + ")");
    $("#infGameContainer").css("transform", "scale(" + _0x5c60a6 + ")");
    var _0x5c60a6 = Math.max(Math.min(1.6 * clientHeight, clientWidth, 1400) / 1400, 0.5);
    $(".slide-box").css("transform", "scale(" + _0x5c60a6 + ")");
    _0x38c054(true, true);
    hideContextMenu();
    if ((0 < _0x2de48c || 0 < _0x517404) && (_0x2de48c = Math.clamp(_0x2de48c, 200, clientWidth), _0x517404 = Math.clamp(_0x517404, 200, clientHeight), _0x363e25)) {
        $("#friendDialog").css({
            "width": _0x2de48c + "px",
            "height": _0x517404 + "px"
        });
...
function _0x585560() {
    var _0x40e852 = Math.max(clientHeight / _0x2cd9d1, clientWidth / _0x247d2d);
...
function _0x38c054(_0x52aa22, _0x126949) {
    ...
    var _0xa9f7bb;
    var _0x17003b = Math.max(Math.min(1.6 * clientHeight, clientWidth, 1400) / 1400, 0.5);
    var _0x1caff2 = _0x4386c1 ? 80 : 105;
    if (_0x56ca1f) {
    ...
    switch (_0x2c4b45) {
        ...
        case 1:
            if (1 != _0x47ccce) {
                ...
                if (!_0x5e4a11) {
                    curserMessage("You have activated the force. Press W to eject the force, and push other cells away. If you are split into many cells, choose/select what cell to shoot the 360 shot by clicking on it.", false, false, 1, 3);
                }
            } else {
                _0x47ccce = 0;
                $("#inv360Shot").removeClass("activatedInv");
                if (!_0x5e4a11) {
                    curserMessage("You have deactivated the force. W will eject normal food cells", false, false, 0, 3);
                }
            }
            break;
        case 2:
        ...
        case 3:
            if (3 != _0x47ccce) {
                ...
                if (!_0x5e4a11) {
                    curserMessage("You have activated the frozen virus. Press W to eject it and split & freeze other players", false, false, 1, 3);
                }
            } else {
                _0x47ccce = 0;
                $("#invFrozenVirus").removeClass("activatedInv");
                if (!_0x5e4a11) {
                    curserMessage("You have deactivated the frozen virus. W will eject normal food cells", false, false, 0, 3);
                }
            }
    }
    if (isReady()) {
...
function _0x4801bb() {
    ...
    if (!(_0x181957 || _0x3e08c0 || 1 != _0x489844 && 2 != _0x489844 && 3 != _0x489844 && 4 != _0x489844 && 5 != _0x489844 && 6 != _0x489844 && 8 != _0x489844 && 9 != _0x489844 && 10 != _0x489844 && 11 != _0x489844 && 12 != _0x489844 && 14 != _0x489844)) {
        ...
        function _0x277ade(_0x48bba7, _0x57d355, _0x4f9aca, _0x2cb7b3, _0x4ce9ff) {
            (_0x114a07 = new Cell(0, 0, 0, 0)).type = _0x48bba7;
            _0x114a07.size = _0x114a07.oSize = _0x114a07.nSize = _0x114a07.strokeSize = _0x57d355;
            if (4 == _0x48bba7) {
...
function _0x4bfb7f(_0x4c8c78) {
    _0x4c8c78.setUint32(_0x9b1a41(2) + (() => {
        var _0x1251b9 = 0;
        for (var i = 2; i < _0xaee6f6.length; i++) {
            _0x1251b9 += ~~(_0x52383b / _0xaee6f6[i] - _0xaee6f6[i] % _0xa19eb5);
        }
        return _0x1251b9;
    })() + _0xa19eb5 + 1);
}
...
function _0x489880() {
    var cell;
    var _0x4216d7 = allNonFoodCells.length;
    for (var i = 0; i < _0x4216d7; i++) {
        if (!(0 != (cell = allNonFoodCells[i]).type && 3 != cell.type)) {
            if (cell.shape < 2) {
                cell.rotation = (2 * Math.random() - 1) * Math.PI;
            }
            if (gameSettings.sLineShapes) {
                ...
                cell.shape = foodCellRandomShapes[cell.id % 100];
            }
        }
    }
}
...
function _0x4f401c(_0x4aa53c) {
    var _0x2e6191 = (_0x4aa53c - mapInfos.updateTime) / 1100;
    mapInfos.left = (_0x2e6191 = _0x2e6191 < 0 ? 0 : 1 < _0x2e6191 ? 1 : _0x2e6191) * (mapInfos.nLeft - mapInfos.oLeft) + mapInfos.oLeft;
    mapInfos.top = _0x2e6191 * (mapInfos.nTop - mapInfos.oTop) + mapInfos.oTop;
    mapInfos.right = _0x2e6191 * (mapInfos.nRight - mapInfos.oRight) + mapInfos.oRight;
    mapInfos.bottom = _0x2e6191 * (mapInfos.nBottom - mapInfos.oBottom) + mapInfos.oBottom;
}
...
var _0x29246b = false;
var _0x5ae1b6 = 0;
var _0x53b8b0 = viewX = ~~((_0x28f6af + _0x5c1aa9) / 2);
var _0x464afc = viewY = ~~((_0x500945 + _0x4ba286) / 2);
...
function _0x161cd2() {
    ...
    if (_0x597133) {
        ...
        if (can_blue_name)         _0x44a2c1.sBlueNameEnabled = blueNameEnabled;
        if (can_orange_name)       _0x44a2c1.sOrangeNameEnabled = orangeNameEnabled;
        if (can_red_name)          _0x44a2c1.sRedNameEnabled = redNameEnabled;
        if (can_black_name)        _0x44a2c1.sBlackNameEnabled = blackNameEnabled;
        if (can_custom_color_name) _0x44a2c1.sCustomColorNameEnabled = customColorNameEnabled;
...
window.setCellsSplit = function() {
    $("#cellsAmount").text(mainPlayerCells.length);
};
window.setTopMass = function(_0x29926a) {
    $("#cellsAmount").text(mainPlayerCells.length);
    if (mainPlayerCells.length) {
...
window.setMegaphoneText = function() {
    ...
    if (-1 != badwords.indexOf(_0x5b7db2.replace(/ /g, '').toLowerCase())) {
        _0x5b7db2 = '';
    }
    ...
    $("#megaphone_cell_name").text(_0x5b7db2).css("color", 1 < _0x35d709 ? nicknameColors[_0x35d709] : '').removeClass("gold black");
    if (1 == _0x35d709) {
...
function autoLogin(_0x3bd3de, _0x5ccbf5) {
    var _0x5a69a7;
    if (_0x582d99) {
...
function _0x26af75() {
    if (isLoggedIn || $("#dashPanel").is(":visible")) {
        _0x522c0e();
        if (_0x53e3b2) {
            clearInterval(_0x53e3b2);
            _0x53e3b2 = 0;
    ...
    return {
        ...
        "success": function(_0x439b93) {
            ...
            if (_0x50746b) {
                ...
                curserMessage(_0x57712b, false, false, 0, 10);
            } else {
        ...
        "error": function() {
            curserMessage("Error: unable to upload file to server. Please contact staff at the forums.", false, false, 0, 10);
        },
        "complete": function() {
...
function _0x2808de(_0x2a55e3) {
    ...
    if (supportFileDragAndDrop && (_0x2a55e3.dataTransfer && (_0x2a55e3.dataTransfer.dropEffect = "copy"), $("#customBackContainer").removeClass("drag-over"), _0x2a55e3.dataTransfer)) {
        if (_0x2a55e3.dataTransfer.files && 0 < _0x2a55e3.dataTransfer.files.length) {
            ...
            curserMessage("Error: please save an image from another site to your computer before uploading it on agma", false, false, 0, 10);
        }
    }
}
...
function _0x24c563(_0x468277) {
    if (_0x468277) {
        ...
        _0x176d4a.onabort = _0x176d4a.onerror = function() {
            curserMessage("Error: something went wrong while loading the file. Please try again.", false, false, 0, 10);
            _0x236671();
        };
        try {
            _0x176d4a.readAsDataURL(_0x468277);
        } catch (_0x5dbbe7) {
            curserMessage("Error: an unexpected error occurred with the selected file", false, false, 0, 10);
            _0x236671();
        }
        ...
        try {
            ...
            _0x35c5f.onload = function() {
                ...
                if (_0x35c5f && _0x35c5f.complete && 0 != _0x35c5f.width) {
                    ...
                    curserMessage("Error: the background image did not load successfully. Please try again.", false, false, 0, 10);
                    _0x350e59('');
                }
                _0x35c5f = null;
                _0x37e4bf = false;
            ...
            _0x35c5f.onerror = function() {
                curserMessage("Error: the background image could not be loaded", false, false, 0, 10);
                _0x350e59('');
                _0x35c5f = null;
                _0x37e4bf = false;
            };
            ...
            curserMessage("Error: something went wrong while loading the background image", false, false, 0, 10);
            _0x37e4bf = false;
        }
    } else {
...
function setSetting(_0x27a0fe, _0x427b0f) {
        ...
        if (3 <= parseInt($("#skinContainer" + _0x164677).attr("data-pendingapproval"))) {
            ...
            for (var _0x256897 = 0; _0x256897 < _0x4a7a01.length; _0x256897++) {
                if (!/[\x20-\xff]/.test(_0x4a7a01.charAt(_0x256897))) {
                    return void curserMessage("Please choose another skinname - unicode characters are not allowed", false, false, 0, 10);
                }
            }
            _0x34efff(true);
            if (isReady()) {
...
window.uploadCustomBack = function() {
    if (!(_0x7f089d || _0x12c3b0 > Date.now())) {
        if ("FileReader" in window) {
            ...
            curserMessage("Sorry, custom backgrounds are not supported on your system. Maybe try another browser?", false, false, 0, 10);
        }
    }
};
...
window.kickPartyMember = function(_0x202c22) {
    if (_0x2c99f2) {
        return curserMessage("please wait 3 seconds before kicking");
    }
...
window.quizAnswer = function(_0x3ff1b5, _0x4eada8) {
    return _0x1d4fed && _0x4eada8 ? swal('', "You have already answered the quiz for today", "error") : isLoggedIn ? void(_0x4eada8 ? isLoggedIn && _0x54207c && _0x20546f && isReady() && (_0x1d4fed = _0x20546f, new PacketWriter(3).setUint8(185).setUint8(_0x20546f).setUint8(_0x54207c).send()) : _0x54207c = _0x3ff1b5) : swal('', "You must be logged in to participate in the quiz", "error");
};
...
window.friendAdd = function(_0xf5b082) {
    if ('' == (_0xf5b082 = _0xf5b082.trim())) {
        curserMessage("Please type a username first", false, false, 0, 5);
    } else {
        sendString(81, _0xf5b082);
...
window.displayInfoDialog = function(_0x128329) {
    ...
    if (!isLoggedIn) {
        ...
        if (isLoggedIn && "infoHolderRegister" == _0x128329) {
            _0x2d4fef = false;
        }
...
window.setDark = function(isEnabled) {
    ...
    var _0x2fadfd;
    var color, r, g, b;
    var _0x3d9bcc = allNonFoodCells.length;
    for (var i = 0; i < _0x3d9bcc; i++) {
        _0x2fadfd = allNonFoodCells[i];
...
window.setSlowMotion = function(isEnabled) {
    if (!(gameSettings.sSlowMotion = isEnabled)) {
        var _0x14189e = allNonFoodCells.length;
        for (var i = 0; i < _0x14189e; i++)
            allNonFoodCells[i].ga = 1;
    }
};
...
window.refreshDanceMenuLocks = function() {
    var _0x4e9d51 = document.querySelectorAll("#danceEmojisBox td[data-dance-req]");
    for (var i = 0; i < _0x4e9d51.length; i++) {
        var _0x429f02 = _0x4e9d51[i];
        var _0x1588d9 = parseInt(_0x429f02.getAttribute("data-dance-req") || "0", 10) || 0;
        var _0x236603 = _0x429f02.querySelector("div");
        var _0xed6124 = _0x1588d9 <= accountRessources.level;
        _0x429f02.title = _0xed6124 ? "/" + (_0x429f02.getAttribute("data-dance-cmd") || '') : "Requires level " + _0x1588d9;
        if (_0x236603) {
            _0x236603.style.opacity = _0xed6124 ? "1" : ".45";
            _0x236603.style.filter = _0xed6124 ? "none" : "grayscale(35%)";
            _0x236603.style.cursor = _0xed6124 ? "pointer" : "not-allowed";
        }
    }
};
...
window.plDA = function(_0x5d5106) {
    var _0x3c3c10;
    if (_0x5d5106) {
        if (accountRessources.level < (_0x3c3c10 = playerDances[_0x5d5106] || 0)) {
            curserMessage("Dance '/" + _0x5d5106 + "' requires level " + _0x3c3c10, false, true, 0, 4);
        } else {
            _0x483c7e("/" + _0x5d5106);
        }
    }
...
window.setDefaults = function() {
    ...
    setSetting("cMinionNames", true);
    setSetting("cMass", true);
    setSetting("cFood", true);
    setSetting("cFoodHalf", false);
    setSetting("cCellAnimations", true);
    setSetting("cSkinAnimations", true);
    setSetting("cMapBorder", true);
    setSetting("cFancyGrid", true);
    setSetting("cSectionGrid", false);
    setSetting("cGrid", false);
    setSetting("cCustomBack", false);
    setSetting("cCustomBackClip", false);
    setSetting("cCustomBackEnableColor", false);
    setSetting("cDark", false);
    setSetting("cSlowMotion", false);
    setSetting("cFPS", true);
    setSetting("cSounds", true);
    setSetting("cZoom", true);
    setSetting("cFixedZoom", false);
    setSetting("cMinionUi", false);
    setSetting("cLeaderboard", true);
    setSetting("cChat", true);
    setSetting("cChatSize", false);
    setSetting("cMinimap", true);
    setSetting("cCellBorders", false);
    setSetting("cLargeNames", false);
    setSetting("cNameOutlines", true);
    setSetting("cCellSpikes", true);
    setSetting("cClassicViruses", false);
    setSetting("cPolygonShapes", false);
...
function newImage(_0x5686e6) {
    var _0x280d05 = new Image();
    _0x280d05.src = _0x5686e6;
    return _0x280d05;
}

function newCanvasImage(_0x3ce60c) {
...
function _0x1cb610(_0x3d1bc7, _0x3fc0c5) {
    wearablesAndObjectsImages[_0x3d1bc7 + "_lo"] = newImage("skins/objects/" + _0x3d1bc7.toString() + "_lo.png?v=" + objectsApiVersion);
    wearablesAndObjectsImages[_0x3d1bc7] = newImage("skins/objects/" + _0x3d1bc7.toString() + ".png?v=" + objectsApiVersion);
}

function _0x22f945(_0x357425) {
    wearablesAndObjectsImages["W" + _0x357425 + "_lo"] = newImage("wearables/" + _0x357425.toString() + "_lo.png?v=" + wearablesApiVersion);
    wearablesAndObjectsImages["W" + _0x357425] = newImage("wearables/" + _0x357425.toString() + ".png?v=" + wearablesApiVersion);
}
...
window.hotkeySetDefaults = function() {
    _0x3569f8.Space = { c: 32, d: "SPACE" };
    _0x3569f8.W = { c: 87, d: "W" };
    _0x3569f8.V = { c: 86, d: "V" };
    _0x3569f8.Z = { c: 90, d: "Z" };
    _0x3569f8.F = { c: 70, d: "F" };
    _0x3569f8.Q = { c: 81, d: "Q" };
    _0x3569f8.E = { c: 69, d: "E" };
    _0x3569f8.S = { c: 83, d: "S" };
    _0x3569f8.A = { c: 65, d: "A" };
    _0x3569f8.X = { c: 88, d: "X" };
    _0x3569f8.I = { c: 73, d: "I" };
    _0x3569f8.C = { c: 67, d: "C" };
    _0x3569f8.D = { c: 68, d: "D" };
    _0x3569f8.T = { c: 84, d: "T" };
    _0x3569f8.M = { c: 77, d: "M" };
    _0x3569f8.W360 = { c: 87, d: "W" };
    _0x3569f8.DW = { c: 66, d: "B" };
...
if (!window.requestAnimationFrame) {
    window.requestAnimationFrame = function(_0x216a8a) {
        return setTimeout(_0x216a8a, FRAMERATE);
    };
}
$(function() {
    _0x37a723 = true;
    ...
    _0x4bbc29.addEventListener("click", function(_0x4e899f) {
        ...
        if (0 == (_0x2aaecd = document.getElementById("reset-pass-input").value).length) {
            ...
            swal({
                ...
                var _0xd49b2e = isLoggedIn && _0xea465f.trim().toLowerCase() == _0x2aaecd.trim().toLowerCase() ? _0x170269 : '';
    ...
    const _0x9a0ff1 = [
        [{ c: "spin", l: "Spin" }, { c: "jump", l: "Jump" }, { c: "flip", l: "Flip" }, { c: "shake", l: "Shake" }, { c: "quake", l: "Quake" }],
        [{ c: "orbit", l: "Orbit" }, { c: "drift", l: "Drift" }, { c: "sway", l: "Sway" }, { c: "vortex", l: "Vortex" }, { c: "glitch", l: "Glitch" }],
        [{ c: "moonwalk", l: "Moonwalk" }, { c: "jelly", l: "Jelly" }, { c: "slinky", l: "Slinky" }, { c: "helix", l: "Helix" }, { c: "hiccup", l: "Hiccup" }],
        [{ c: "boogie", l: "Boogie" }, { c: "crazy", l: "Crazy" }, { c: "funny", l: "Funny" }, { c: "zigzag", l: "Zigzag" }, { c: "pulse", l: "Pulse" }]
    ];
    var _0x2a3d82 = "<tbody id=\"danceEmojisBox\" style=\"display:none\">";
    for (const row of _0x9a0ff1) {
        _0x2a3d82 += "<tr>";
        for (const { c: _0x2b919c, l: _0xef3925 } of row) {
            const level = playerDances[_0x2b919c] || 0;
            _0x2a3d82 += "<td data-dance-cmd='" + _0x2b919c + "' data-dance-req='" + level + "' onclick=\"plDA('" + _0x2b919c + "');\" title='/" + _0x2b919c + "'><div style=\"padding:4px 6px;background:#243041;border:1px solid #3d4f66;border-radius:4px;color:#c9ddff;font-size:11px;text-align:center;\">" + (0 < level ? _0xef3925 + "<br><span style='font-size:10px;color:#aeb8c7'>Lvl " + level + "</span>" : _0xef3925) + "</div></td>";
        }
        _0x2a3d82 += "</tr>";
    }
    _0x5e2db3 += "</tbody> <tbody id=\"animatedEmojisBox\"><tr><td onclick=\"plEA(32);\"> <img width=\"28\" src=\"./emotes/anim/icon_hearts.png\"></img></td><td onclick=\"plEA(30);\"> <img width=\"28\" src=\"./emotes/anim/icon_wave.png\"></img></td><td onclick=\"plEA(12);\"> <img width=\"28\" src=\"./emotes/anim/icon_wacky.png\"></img></td><td onclick=\"plEA(31);\"> <img width=\"28\" src=\"./emotes/anim/icon_explo_head.png\"></img></td><td onclick=\"plEA(44);\"> <img width=\"28\" src=\"./emotes/anim/icon_threm.png\"></img></td><td onclick=\"plEA(45);\"> <img width=\"28\" src=\"./emotes/anim/icon_sweatface.png\"></img></td><td onclick=\"plEA(46);\"> <img width=\"28\" src=\"./emotes/anim/icon_tearsjoy.png\"></img></td></tr> <tr><td onclick=\"plEA(47);\"> <img width=\"28\" src=\"./emotes/anim/icon_nono.png\"></img></td><td onclick=\"plEA(48);\"> <img width=\"28\" src=\"./emotes/anim/icon_clap.png\"></img></td><td onclick=\"plEA(49);\"><img width=\"28\" src=\"./emotes/anim/icon_crying.png\"></img></td><td onclick=\"plEA(50);\"><img width=\"28\" src=\"./emotes/anim/icon_devsmile.png\"></img></td><td onclick=\"plEA(0);\"><img width=\"28\" src=\"./emotes/anim/icon_eatman.png\"></img></td><td onclick=\"plEA(52);\"><img width=\"28\" src=\"./emotes/anim/icon_trophy.png\"></img></td><td onclick=\"plEA(53);\"><img width=\"28\" src=\"./emotes/anim/icon_heartsv.png\"></img></td></tr></tbody>" + _0x2a3d82 + "</tbody></table></div><p style='padding:10px 5px 0px;color:#444444;font-size:9px;font-weight:bold;'></p>";
    ...
    $.post("client.php", {
        ...
        if (window.emgaa && _0x21e509 && !isNaN(_0x21e509) && (_0x2b8278 = (_0x38337e => {
            ...
            curserMessage("Unable to connect! Please refresh your browser and try again.", false, true, 0, 0);
        }
    }, "text");
});
